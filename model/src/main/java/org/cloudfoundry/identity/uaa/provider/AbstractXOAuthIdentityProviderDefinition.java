...
public abstract class AbstractXOAuthIdentityProviderDefinition<
        T extends AbstractXOAuthIdentityProviderDefinition>
  ...
  public boolean equals(Object o) {
    ...
    AbstractXOAuthIdentityProviderDefinition<?> that =
        (AbstractXOAuthIdentityProviderDefinition<?>) o;
    ...
    if (tokenKeyUrl != null ? !tokenKeyUrl.equals(that.tokenKeyUrl) : that.tokenKeyUrl != null)
      return false;
    ...
    if (relyingPartyId != null
        ? !relyingPartyId.equals(that.relyingPartyId)
        : that.relyingPartyId != null) return false;
    if (relyingPartySecret != null
        ? !relyingPartySecret.equals(that.relyingPartySecret)
        : that.relyingPartySecret != null) return false;
