...
public class OIDCIdentityProviderDefinition
    extends AbstractXOAuthIdentityProviderDefinition<OIDCIdentityProviderDefinition>
  ...
  public boolean equals(Object o) {
    ...
    if (userInfoUrl != null ? !userInfoUrl.equals(that.userInfoUrl) : that.userInfoUrl != null)
      return false;
    if (this.passwordGrantEnabled != that.passwordGrantEnabled) return false;
    return discoveryUrl != null
        ? discoveryUrl.equals(that.discoveryUrl)
        : that.discoveryUrl == null;
  }
