...
public class MetricsUtils {
  ...
  public NotificationEmitter getUaaMetricsSubscriber(MBeanServerConnection server)
      throws Exception {
    ObjectName mbeanName = new ObjectName("cloudfoundry.identity:name=ServerRequests");
    return (NotificationEmitter) JMX.newMBeanProxy(server, mbeanName, UaaMetrics.class, true);
  }

  public Map<String, ?> pullUpMap(String domain, String pattern, MBeanServerConnection server)
      throws Exception {
  ...
  public Map<String, ?> getMBeans(String domain, String pattern, MBeanServerConnection server)
      throws Exception {
