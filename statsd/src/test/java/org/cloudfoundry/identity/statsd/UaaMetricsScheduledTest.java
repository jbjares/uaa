...
public class UaaMetricsScheduledTest {
  ...
  @Autowired private UaaMetricsEmitter uaaMetricsEmitter;

  @Test
  public void emittingMetrics_Is_Scheduled() throws Exception {
    Scheduled schedulerAnnotation =
        uaaMetricsEmitter.getClass().getMethod("emitMetrics").getAnnotation(Scheduled.class);
