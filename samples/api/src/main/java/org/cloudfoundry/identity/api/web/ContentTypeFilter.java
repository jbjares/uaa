...
/**
 * A servlet filter that adds a content type header to any path that matches one of a set of path
 * patterns. Used to serve static content without a filename extension with a specific media type,
 * for instance.
 *
 * @author Dave Syer
 */
public class ContentTypeFilter implements Filter {
  ...
  /**
   * Maps the paths that should be matched to specific media types. The paths should begin with a
   * leading "/" and should not include the application context path.
   *
