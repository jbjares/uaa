...
public class JdbcApprovalStore
  ...
  public static final String DELETE_OF_USER_APPROVALS_BY_PROVIDER =
      "delete from authz_approvals where user_id in (select id from users where identity_zone_id = ? and origin = ?)";
          ...
          jdbcTemplate.update(
              ...
              new PreparedStatementSetter() {
                ...
                public void setValues(PreparedStatement ps) throws SQLException {
                  ...
                  ps.setString(
                      5,
                      (approval.getStatus() == null ? APPROVED : approval.getStatus()).toString());
