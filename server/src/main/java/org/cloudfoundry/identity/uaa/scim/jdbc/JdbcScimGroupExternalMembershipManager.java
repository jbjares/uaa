...
public class JdbcScimGroupExternalMembershipManager implements ScimGroupExternalMembershipManager {
  ...
  public static final String JOIN_EXTERNAL_GROUP_MAPPING_FIELDS =
  ...
  public static final String JOIN_GROUP_TABLE =
  ...
  private final RowMapper<ScimGroupExternalMember> rowMapper =
      new ScimGroupExternalMemberRowMapper();
  ...
  public List<ScimGroupExternalMember> getExternalGroupMappings(String zoneId)
    ...
    return jdbcTemplate.query(
        GET_EXTERNAL_GROUP_MAPPINGS_IN_ZONE_SQL,
        new PreparedStatementSetter() {
          @Override
          public void setValues(PreparedStatement ps) throws SQLException {
  ...
  public List<ScimGroupExternalMember> getExternalGroupMapsByGroupName(
    ...
    final List<ScimGroup> groups =
        scimGroupProvisioning.query(
            String.format("displayName eq \"%s\"", groupName), IdentityZoneHolder.get().getId());
