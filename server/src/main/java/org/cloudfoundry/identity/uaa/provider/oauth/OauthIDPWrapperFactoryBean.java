...
public class OauthIDPWrapperFactoryBean {
  private Map<String, AbstractXOAuthIdentityProviderDefinition> oauthIdpDefinitions =
      new HashMap<>();
      ...
      for (String alias : definitions.keySet()) {
        ...
        try {
          ...
          if (OAUTH20.equalsIgnoreCase(type)) {
            RawXOAuthIdentityProviderDefinition oauthIdentityProviderDefinition =
  ...
  protected void setCommonProperties(
      ...
      AbstractXOAuthIdentityProviderDefinition idpDefinition) {
  ...
  public void setOauthIdpDefinitions(
      Map<String, AbstractXOAuthIdentityProviderDefinition> oauthIdpDefinitions) {
