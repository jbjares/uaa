...
public class YamlServletProfileInitializer
  ...
  public static final String[] DEFAULT_PROFILE_CONFIG_FILE_LOCATIONS =
      new String[] {"${APPLICATION_CONFIG_URL}", "file:${APPLICATION_CONFIG_FILE}"};
  ...
  public void initialize(ConfigurableWebApplicationContext applicationContext) {
    ...
    try {
      ...
      servletContext.log(
          "Error loading YAML environment properties from location: " + resources.toString(), e);
    }
  }
  ...
  protected Resource getYamlFromEnvironmentVariable() {
    if (getEnvironmentAccessor() != null) {
      String data =
          getEnvironmentAccessor().getEnvironmentVariable(getYamlEnvironmentVariableName());
      if (hasText(data)) {
  ...
  protected void applySpringProfiles(
      ConfigurableEnvironment environment, ServletContext servletContext) {
