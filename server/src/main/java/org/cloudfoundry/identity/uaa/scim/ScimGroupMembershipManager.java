...
public interface ScimGroupMembershipManager {
   ...
   * @throws MemberNotFoundException
   */
  ScimGroupMember removeMemberById(String groupId, String memberId, final String zoneId)
      throws ScimResourceNotFoundException, MemberNotFoundException;
   ...
   * @throws ScimResourceNotFoundException
   */
  List<ScimGroupMember> removeMembersByGroupId(String groupId, final String zoneID)
      throws ScimResourceNotFoundException;
   ...
   * @throws ScimResourceNotFoundException
   */
  Set<ScimGroup> removeMembersByMemberId(String memberId, final String zoneId)
      throws ScimResourceNotFoundException;

  Set<ScimGroup> removeMembersByMemberId(String memberId, String origin, final String zoneId)
      throws ScimResourceNotFoundException;
   ...
   * @throws ScimResourceNotFoundException
   */
  Set<ScimGroup> getGroupsWithExternalMember(String memberId, String origin)
      throws ScimResourceNotFoundException;
}
