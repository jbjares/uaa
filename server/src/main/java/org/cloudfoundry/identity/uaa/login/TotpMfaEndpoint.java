...
public class TotpMfaEndpoint implements ApplicationEventPublisherAware {
      ...
      if (mfaCredentialsProvisioning.isValidCode(credentials, codeValue)) {
        ...
        publish(
            new MfaAuthenticationSuccessEvent(
                getUaaUser(uaaPrincipal), uaaAuth, getMfaProvider().getType().toValue()));
  ...
  public void setUserGoogleMfaCredentialsProvisioning(
      UserGoogleMfaCredentialsProvisioning userGoogleMfaCredentialsProvisioning) {
