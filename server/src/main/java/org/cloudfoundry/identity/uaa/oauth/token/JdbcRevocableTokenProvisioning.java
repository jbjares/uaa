...
public class JdbcRevocableTokenProvisioning implements RevocableTokenProvisioning, SystemDeletable {
  ...
  protected static final String UPDATE_FIELDS =
  ...
  protected static final String GET_BY_USER_QUERY =
      "SELECT " + FIELDS + " FROM " + TABLE + " WHERE user_id=? AND identity_zone_id=?";
  protected static final String GET_BY_CLIENT_QUERY =
  ...
  protected static final String DELETE_EXPIRED_QUERY =
      "DELETE FROM " + TABLE + " WHERE expires_at < ?";
  protected static final String DELETE_REFRESH_TOKEN_QUERY =
      "DELETE FROM "
          + TABLE
          + " WHERE user_id=? AND client_id=? AND response_type='"
          + REFRESH_TOKEN_RESPONSE_TYPE
          + "' AND identity_zone_id=?";
  protected static final String DELETE_BY_CLIENT_QUERY =
      "DELETE FROM " + TABLE + " WHERE client_id = ? AND identity_zone_id=?";
  protected static final String DELETE_BY_USER_QUERY =
      "DELETE FROM " + TABLE + " WHERE user_id = ? AND identity_zone_id=?";
  protected static final String DELETE_BY_ZONE_QUERY =
  ...
  public List<RevocableToken> getUserTokens(String userId, String clientId, String zoneId) {
    ...
    return getUserTokens(userId, zoneId)
        .stream()
  ...
  public void checkExpired() {
    ...
    if ((now - lastCheck) > getExpirationCheckInterval()
