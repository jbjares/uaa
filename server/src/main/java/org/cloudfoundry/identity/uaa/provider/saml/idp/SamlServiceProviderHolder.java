...
public class SamlServiceProviderHolder {
  ...
  public boolean equals(Object obj) {
    ...
    if (samlServiceProvider.getIdentityZoneId() == null) {
      if (other.samlServiceProvider.getIdentityZoneId() != null) return false;
    } else if (!samlServiceProvider
        .getIdentityZoneId()
        .equals(other.samlServiceProvider.getIdentityZoneId())) return false;
    if (samlServiceProvider.getEntityId() == null) {
      if (other.samlServiceProvider.getEntityId() != null) return false;
