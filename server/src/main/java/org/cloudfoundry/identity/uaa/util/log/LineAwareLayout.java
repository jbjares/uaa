...
public class LineAwareLayout extends Layout {
  ...
  public String format(LoggingEvent event) {
    if (lineLayout == null) {
      return messageLayout == null ? event.getRenderedMessage() : messageLayout.format(event);
    }
  ...
  private static LoggingEvent replaceEventMessageWithoutThrowable(
      LoggingEvent event, String message) {
