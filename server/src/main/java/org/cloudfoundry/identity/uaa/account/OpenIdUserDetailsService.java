...
/**
 * Custom UserDetailsService which accepts any OpenID user, "registering" new users in a map so they
 * can be welcomed back to the site on subsequent logins.
 *
 * @author Luke Taylor
 * @author Dave Syer
 * @since 3.1
...
public class OpenIdUserDetailsService
  ...
  /**
   * Implementation of {@code AuthenticationUserDetailsService} which allows full access to the
   * submitted {@code Authentication} object. Used by the OpenIDAuthenticationProvider.
   */
  @Override
