...
public class JdbcSamlServiceProviderProvisioning
  ...
  public SamlServiceProvider retrieve(String id, String zoneId) {
    SamlServiceProvider serviceProvider =
        jdbcTemplate.queryForObject(SERVICE_PROVIDER_BY_ID_QUERY, mapper, id, zoneId);
  ...
  public SamlServiceProvider retrieveByEntityId(String entityId, String zoneId) {
    SamlServiceProvider serviceProvider =
        jdbcTemplate.queryForObject(SERVICE_PROVIDER_BY_ENTITY_ID_QUERY, mapper, entityId, zoneId);
    return serviceProvider;
  }
