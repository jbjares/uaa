...
public abstract class ClientServicesExtension
    implements ClientRegistrationService, ClientDetailsService {

  public abstract void addClientSecret(String clientId, String newSecret, String zoneId)
      throws NoSuchClientException;

  public abstract void deleteClientSecret(String clientId, String zoneId)
      throws NoSuchClientException;
  ...
  public abstract void addClientDetails(ClientDetails clientDetails, String zoneId)
      throws ClientAlreadyExistsException;
  ...
  public abstract void updateClientDetails(ClientDetails clientDetails, String zoneId)
      throws NoSuchClientException;
  ...
  public abstract void updateClientSecret(String clientId, String secret, String zoneId)
      throws NoSuchClientException;
  ...
  public abstract void removeClientDetails(String clientId, String zoneId)
      throws NoSuchClientException;
  ...
  public abstract ClientDetails loadClientByClientId(String clientId, String zoneId)
      throws ClientRegistrationException;
}
