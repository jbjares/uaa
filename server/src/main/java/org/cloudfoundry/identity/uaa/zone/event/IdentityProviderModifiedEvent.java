...
public class IdentityProviderModifiedEvent extends AbstractUaaEvent {
  ...
  public IdentityProviderModifiedEvent(
      IdentityProvider identityProvider, Authentication authentication, AuditEventType type) {
  ...
  public static IdentityProviderModifiedEvent identityProviderCreated(
    ...
    return new IdentityProviderModifiedEvent(
        identityProvider, getContextAuthentication(), AuditEventType.IdentityProviderCreatedEvent);
  }

  public static IdentityProviderModifiedEvent identityProviderModified(
      IdentityProvider identityProvider) {
    return new IdentityProviderModifiedEvent(
        identityProvider, getContextAuthentication(), AuditEventType.IdentityProviderModifiedEvent);
  }
}
