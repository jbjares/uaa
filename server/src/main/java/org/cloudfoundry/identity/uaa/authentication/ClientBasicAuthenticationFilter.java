...
/**
 * This class is an extension of Spring Framework BasicAuthenticationFilter that observes the client
 * lockout policy and throws ClientLockoutException when the client attempting to authenticate is
 * locked out.
 */
      ...
      Timestamp lastModified =
          (Timestamp)
              clientDetailsService
                  ...
                  .get(ClientConstants.LAST_MODIFIED);
