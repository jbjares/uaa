...
public class IdentityProviderEndpoints implements ApplicationEventPublisherAware {
  ...
  public ResponseEntity<IdentityProvider> deleteIdentityProvider(
    ...
    IdentityProvider existing =
        identityProviderProvisioning.retrieve(id, IdentityZoneHolder.get().getId());
          ...
          if (provider.getConfig() instanceof AbstractXOAuthIdentityProviderDefinition) {
            ...
            if (definition.getRelyingPartySecret() == null) {
              ...
              if (existing != null
                ...
                AbstractXOAuthIdentityProviderDefinition existingDefinition =
                    (AbstractXOAuthIdentityProviderDefinition) existing.getConfig();
