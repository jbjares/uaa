...
public class InvitationsController {
  ...
  public void setZoneAwareAuthenticationManager(
  ...
  public String acceptInvitePage(
    ...
    try {
      ...
      if (isUaaUserAndVerified || isExternalUserAndAcceptedInvite) {
        ...
        String redirect =
            "redirect:/" + SamlRedirectUtils.getIdpRedirectUrl(definition, getSpEntityID());
        logger.debug(
            String.format(
        ...
        AbstractXOAuthIdentityProviderDefinition definition =
            ObjectUtils.castInstance(
                provider.getConfig(), AbstractXOAuthIdentityProviderDefinition.class);
        ...
        AnonymousAuthenticationToken token =
            new AnonymousAuthenticationToken(
                "scim.invite", uaaPrincipal, Arrays.asList(UaaAuthority.UAA_INVITED));
  ...
  protected HttpServletRequestWrapper getNewCodeWrapper(
