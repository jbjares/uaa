...
public class ClientInfoEndpointTests {
  ...
  private BaseClientDetails foo =
      new BaseClientDetails("foo", "none", "read,write", GRANT_TYPE_AUTHORIZATION_CODE, "uaa.none");
  ...
  public void testClientinfo() {
    ...
    ClientDetails client =
        endpoint.clientinfo(new UsernamePasswordAuthenticationToken("foo", "<NONE>"));
