...
public class YamlBindingTests {
  ...
  public static class OAuthConfiguration {
    ...
    public static class OAuthConfigurationValidator
        implements ConstraintValidator<ValidOAuthConfiguration, OAuthConfiguration> {
    ...
    public boolean isValid(Map<String, Object> value, ConstraintValidatorContext context) {
      ...
      for (String key : requiredKeys) {
        if (!value.containsKey(key)) {
          context
              .buildConstraintViolationWithTemplate("Missing key ''" + key + "''")
              .addConstraintViolation();
          valid = false;
        }
      }
