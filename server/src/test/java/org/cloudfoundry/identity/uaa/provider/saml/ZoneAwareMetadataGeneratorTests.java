...
public class ZoneAwareMetadataGeneratorTests {
  ...
  public static final String cert1Plain =
      certificate1
          .replace("-----BEGIN CERTIFICATE-----", "")
          .replace("-----END CERTIFICATE-----", "")
          .replace("\n", "");
  public static final String cert2Plain =
      certificate2
          .replace("-----BEGIN CERTIFICATE-----", "")
          .replace("-----END CERTIFICATE-----", "")
          .replace("\n", "");
  ...
  public void test_metadata_contains_saml_bearer_grant_endpoint() throws Exception {
    ...
    assertThat(
        s,
        containsString(
            "md:AssertionConsumerService Binding=\"urn:oasis:names:tc:SAML:2.0:bindings:URI\" Location=\"http://zone-id.localhost:8080/uaa/oauth/token/alias/zone-id.entityAlias\" index=\"1\"/>"));
  }
