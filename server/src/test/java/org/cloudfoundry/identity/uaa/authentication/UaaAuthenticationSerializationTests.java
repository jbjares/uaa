...
public class UaaAuthenticationSerializationTests {
  ...
  public void test_serialization() throws Exception {
    UaaPrincipal principal =
        new UaaPrincipal("id", "username", "email", "origin", "externalId", "zoneId");
    ...
    assertThat(
        actual.getUserAttributes().get("atest"), containsInAnyOrder("test1", "test2", "test3"));
    assertThat(
        actual.getUserAttributes().get("btest"), containsInAnyOrder("test1", "test2", "test3"));
  ...
  public void testDeserializationWithoutAuthenticatedTime() throws Exception {
    String data =
        "{\"principal\":{\"id\":\"user-id\",\"name\":\"username\",\"email\":\"email\",\"origin\":\"uaa\",\"externalId\":null,\"zoneId\":\"uaa\"},\"credentials\":null,\"authorities\":[],\"details\":null,\"authenticated\":true,\"authenticatedTime\":1438649464353,\"name\":\"username\"}";
    ...
    String dataWithoutTime =
        "{\"principal\":{\"id\":\"user-id\",\"name\":\"username\",\"email\":\"email\",\"origin\":\"uaa\",\"externalId\":null,\"zoneId\":\"uaa\"},\"credentials\":null,\"authorities\":[],\"details\":null,\"authenticated\":true,\"name\":\"username\"}";
    UaaAuthentication authentication2 =
        JsonUtils.readValue(dataWithoutTime, UaaAuthentication.class);
    assertEquals(-1, authentication2.getAuthenticatedTime());

    long inThePast = System.currentTimeMillis() - 1000l * 60l;
    data =
        "{\"principal\":{\"id\":\"user-id\",\"name\":\"username\",\"email\":\"email\",\"origin\":\"uaa\",\"externalId\":null,\"zoneId\":\"uaa\"},\"credentials\":null,\"authorities\":[],\"details\":null,\"authenticated\":true,\"authenticatedTime\":1438649464353,\"name\":\"username\", \"expiresAt\":"
            + inThePast
            + "}";
  ...
  public void deserialization_with_external_groups() throws Exception {
    String dataWithExternalGroups =
        "{\"principal\":{\"id\":\"user-id\",\"name\":\"username\",\"email\":\"email\",\"origin\":\"uaa\",\"externalId\":null,\"zoneId\":\"uaa\"},\"credentials\":null,\"authorities\":[],\"externalGroups\":[\"something\",\"or\",\"other\",\"something\"],\"details\":null,\"authenticated\":true,\"authenticatedTime\":null,\"name\":\"username\"}";
    UaaAuthentication authentication =
        JsonUtils.readValue(dataWithExternalGroups, UaaAuthentication.class);
    assertEquals(3, authentication.getExternalGroups().size());
    assertThat(
        authentication.getExternalGroups(),
        Matchers.containsInAnyOrder("something", "or", "other"));
    assertTrue(authentication.isAuthenticated());
  }

  @Test
  public void deserialization_with_user_attributes() throws Exception {
    String dataWithoutUserAttributes =
        "{\"principal\":{\"id\":\"user-id\",\"name\":\"username\",\"email\":\"email\",\"origin\":\"uaa\",\"externalId\":null,\"zoneId\":\"uaa\"},\"credentials\":null,\"authorities\":[],\"externalGroups\":[\"something\",\"or\",\"other\",\"something\"],\"details\":null,\"authenticated\":true,\"authenticatedTime\":null,\"name\":\"username\", \"previousLoginSuccessTime\":1485305759347}";
    UaaAuthentication authentication =
        JsonUtils.readValue(dataWithoutUserAttributes, UaaAuthentication.class);
    assertEquals(3, authentication.getExternalGroups().size());
    assertThat(
        authentication.getExternalGroups(),
        Matchers.containsInAnyOrder("something", "or", "other"));
    ...
    assertTrue(
        "userAttributes should be part of the JSON",
        dataWithUserAttributes.contains("userAttributes"));

    UaaAuthentication authWithUserData =
        JsonUtils.readValue(dataWithUserAttributes, UaaAuthentication.class);
    assertNotNull(authWithUserData.getUserAttributes());
    assertThat(
        authWithUserData.getUserAttributes().entrySet(),
        everyItem(isIn(userAttributes.entrySet())));
    assertThat(
        userAttributes.entrySet(),
        everyItem(isIn(authWithUserData.getUserAttributes().entrySet())));
