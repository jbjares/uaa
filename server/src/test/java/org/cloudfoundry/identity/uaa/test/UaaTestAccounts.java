...
public class UaaTestAccounts implements TestAccounts {
  ...
  private static Map<String, OAuth2ProtectedResourceDetails> clientDetails =
      new HashMap<String, OAuth2ProtectedResourceDetails>();
  ...
  public String getAdminClientId() {
    return environment.getProperty(
        "UAA_ADMIN_CLIENT_ID", environment.getProperty("oauth.clients.admin.id", "admin"));
  }
  ...
  public String getAuthorizationHeader(
      String prefix, String defaultUsername, String defaultPassword) {
  ...
  public ClientCredentialsResourceDetails getAdminClientCredentialsResource() {
    return getClientCredentialsResource(
        new String[] {"clients.read", "clients.write", "clients.secret", "clients.admin"},
        getAdminClientId(),
        getAdminClientSecret());
  }

  public ClientCredentialsResourceDetails getClientCredentialsResource(
      String prefix, String defaultClientId, String defaultClientSecret) {
    return getClientCredentialsResource(
        prefix,
        new String[] {"scim.read", "scim.write", "password.write"},
        defaultClientId,
        defaultClientSecret);
  }

  public ClientCredentialsResourceDetails getClientCredentialsResource(
      String prefix, String[] scope, String defaultClientId, String defaultClientSecret) {
    ...
    ClientCredentialsResourceDetails resource =
        getClientCredentialsResource(scope, clientId, clientSecret);
  ...
  public ClientCredentialsResourceDetails getClientCredentialsResource(
    ...
    return getClientCredentialsResource(
        new String[] {"cloud_controller.read"}, clientId, clientSecret);
  }
  ...
  public ImplicitResourceDetails getImplicitResource(
      String clientPrefix, String defaultClientId, String defaultRedirectUri) {
    ...
    String redirectUri =
        environment.getProperty(clientPrefix + ".redirect-uri", defaultRedirectUri);
    resource.setPreEstablishedRedirectUri(redirectUri);
    return resource;
  }

  public ResourceOwnerPasswordResourceDetails getResourceOwnerPasswordResource(
      String clientPrefix,
      String defaultClientId,
      String defaultClientSecret,
      String username,
      String password) {
    return getResourceOwnerPasswordResource(
        new String[] {"cloud_controller.read", "openid", "password.write"},
        clientPrefix,
        defaultClientId,
        defaultClientSecret,
        username,
  ...
  @Override
  public ResourceOwnerPasswordResourceDetails getResourceOwnerPasswordResource(
      String[] scope, String clientId, String clientSecret, String username, String password) {
  ...
  public ClientDetails getClientDetails(String prefix, BaseClientDetails defaults) {
    ...
    String scopes =
        environment.getProperty(
            prefix + ".scope", StringUtils.collectionToCommaDelimitedString(defaults.getScope()));
    String grantTypes =
        environment.getProperty(
            prefix + ".authorized-grant-types",
    ...
    BaseClientDetails result =
        new BaseClientDetails(clientId, resourceIds, scopes, grantTypes, authorities, redirectUris);
  ...
  public ResourceOwnerPasswordResourceDetails getDefaultResourceOwnerPasswordResource() {
    return getResourceOwnerPasswordResource(
        "oauth.clients.app", "app", "appclientsecret", getUserName(), getPassword());
  }
  ...
  public AuthorizationCodeResourceDetails getDefaultAuthorizationCodeResource() {
    ...
    String redirectUri =
        environment.getProperty("oauth.clients.app.redirect-uri", "http://localhost:8080/app/");
    result.setPreEstablishedRedirectUri(redirectUri);
    return result;
  }

  public static final String INSERT_BARE_BONE_USER =
      "insert into users (id, username, password, email, identity_zone_id) values (?,?,?,?,?)";
  ...
  public String addRandomUser(JdbcTemplate jdbcTemplate, String id, String zoneId) {
    ...
    jdbcTemplate.update(
        INSERT_BARE_BONE_USER, id, username, "password", username + "@test.com", zoneId);
    return id;
  }
}
