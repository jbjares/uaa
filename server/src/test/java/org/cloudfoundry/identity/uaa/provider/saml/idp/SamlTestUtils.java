...
public class SamlTestUtils {
  ...
  public void initialize() throws ConfigurationException {
    ...
    IdentityZone.getUaa()
        .getConfig()
        .getSamlConfig()
        .setPrivateKeyPassword(PROVIDER_PRIVATE_KEY_PASSWORD);
  ...
  public static SamlIdentityProviderDefinition createLocalSamlIdpDefinition(
      String alias, String zoneId, String idpMetaData) {
  ...
  public Assertion mockAssertion(
    ...
    assertion
        ...
        .getAudiences()
        .get(0)
        .setAudienceURI(audienceEntityID);
  ...
  public String mockAssertionEncoded(
      ...
      throws Exception {
    return mockAssertionEncoded(
        null, issuerEntityID, format, username, spEndpoint, audienceEntityID);
  }
  ...
  public UaaAuthentication mockUaaAuthentication(String id) {
    ...
    UaaPrincipal principal =
        new UaaPrincipal(id, "marissa", "marissa@testing.org", OriginKeys.UAA, "marissa", "uaa");
  ...
  public static final String SAML_SP_METADATA =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
  ...
  public static final String UNSIGNED_SAML_SP_METADATA =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
          + "<md:EntityDescriptor xmlns:md=\"urn:oasis:names:tc:SAML:2.0:metadata\" ID=\"cloudfoundry-saml-login\" entityID=\"cloudfoundry-saml-login\">"
          + "<md:SPSSODescriptor AuthnRequestsSigned=\"true\" WantAssertionsSigned=\"true\" protocolSupportEnumeration=\"urn:oasis:names:tc:SAML:2.0:protocol\">"
          + "<md:KeyDescriptor use=\"signing\">"
  ...
  public static final String UNSIGNED_SAML_SP_METADATA_WITHOUT_ID =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
  ...
  public static final String UNSIGNED_SAML_SP_METADATA_ID_AND_ENTITY_ID =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
  ...
  public static final String UNSIGNED_SAML_SP_METADATA_WITHOUT_SPSSODESCRIPTOR =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
          + "<md:EntityDescriptor xmlns:md=\"urn:oasis:names:tc:SAML:2.0:metadata\" ID=\"%s\" entityID=\"cloudfoundry-saml-login\">"
          + "</md:EntityDescriptor>";
  ...
  public static final String UNSIGNED_SAML_SP_METADATA_WITHOUT_HEADER =
      UNSIGNED_SAML_SP_METADATA_WITHOUT_ID.replace(
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>", "");
  ...
  public static SamlServiceProvider mockSamlServiceProviderForZone(String zoneId) {
    SamlServiceProviderDefinition singleAddDef =
        SamlServiceProviderDefinition.Builder.get()
            .setMetaDataLocation(
                String.format(
                    SamlTestUtils.UNSIGNED_SAML_SP_METADATA_ID_AND_ENTITY_ID,
                    new RandomValueStringGenerator().generate(),
                    MOCK_SP_ENTITY_ID,
                    DEFAULT_NAME_ID_FORMATS))
            .setNameID("sample-nameID")
            .setSingleSignOnServiceIndex(1)
            .setMetadataTrustCheck(true)
            .build();

    return new SamlServiceProvider()
        .setEntityId(MOCK_SP_ENTITY_ID)
        .setIdentityZoneId(zoneId)
  ...
  public static SamlServiceProvider mockSamlServiceProvider(
      String entityId, String nameIdFormatsXML) {
    SamlServiceProviderDefinition singleAddDef =
        SamlServiceProviderDefinition.Builder.get()
            .setMetaDataLocation(
                String.format(
  ...
  public static SamlServiceProvider mockSamlServiceProviderForZoneWithoutSPSSOInMetadata(
      String zoneId) {
    SamlServiceProviderDefinition singleAddDef =
        SamlServiceProviderDefinition.Builder.get()
            .setMetaDataLocation(
  ...
  public static List<String> getCertificates(String metadata, String type) throws Exception {
    ...
    NodeList nodeList =
        evaluateXPathExpression(
            doc,
            "//*[local-name()='KeyDescriptor' and @*[local-name() = 'use']='"
                + type
  ...
  public static NodeList evaluateXPathExpression(Document doc, String xpath)
  ...
  public static Document getMetadataDoc(String metadata)
  ...
  private static IdpWebSsoProfileImpl mockSsoWebProfileImpl() {
    ...
    JdbcSamlServiceProviderProvisioning samlServiceProviderProvisioning =
        mock(JdbcSamlServiceProviderProvisioning.class);
