...
public class ServiceProviderModifiedEventTest {
  ...
  public void evaludateAuditEventData(ServiceProviderModifiedEvent event) {
    assertEquals(
        String.format(
            ServiceProviderModifiedEvent.dataFormat,
            provider.getId(),
            provider.getName(),
