...
public class NotificationsServiceTest {
  ...
  public void setUp() {
    ...
    notificationsService =
        new NotificationsService(
            notificationsTemplate, "http://notifications.example.com", notifications, true) {
          @Override
    ...
    mockNotificationsServer
        .expect(requestTo("http://notifications.example.com/registration"))
  ...
  public void testSendingMessageToEmailAddress() throws Exception {
    ...
    mockNotificationsServer
        .expect(requestTo("http://notifications.example.com/emails"))
    ...
    notificationsService.sendMessage(
        "user@example.com", MessageType.PASSWORD_RESET, "First message", "<p>Message</p>");
