...
public class JdbcQueryableClientDetailsServiceTests extends JdbcTestBase {
  ...
  private static final String INSERT_SQL =
      "insert into oauth_client_details (client_id, client_secret, resource_ids, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, identity_zone_id) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  ...
  public void initJdbcScimClientDetailsServiceTests() {
    ...
    service =
        new JdbcQueryableClientDetailsService(
            delegate, jdbcTemplate, new JdbcPagingListFactory(jdbcTemplate, limitSqlAdapter));
  ...
  private void addClients() {
    ...
    addClient(
        ...
        "secret",
        "tokens,clients",
        "clients.read,clients.write,scim.read,scim.write",
        "client_credentials",
        "myRedirectUri",
        "clients.read,clients.write,scim.read,scim.write",
        100,
  ...
  public void testQueryEquals() {
    ...
    assertEquals(
        ...
        service
            .query(
                "authorized_grant_types eq \"client_credentials\"",
                IdentityZoneHolder.get().getId())
            .size());
  }
