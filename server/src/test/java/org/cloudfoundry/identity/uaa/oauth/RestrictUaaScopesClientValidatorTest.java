...
import static org.cloudfoundry.identity.uaa.client.ClientDetailsValidator.Mode.*;
...
public class RestrictUaaScopesClientValidatorTest {
  ...
  RestrictUaaScopesClientValidator validator =
      new RestrictUaaScopesClientValidator(new UaaScopes());
  ...
  public void testValidate() throws Exception {
    ...
    BaseClientDetails client =
        new BaseClientDetails("clientId", "", "", "client_credentials,password", "");
  ...
  protected void validateClient(
      List<ClientDetailsValidator.Mode> restrictModes,
      List<ClientDetailsValidator.Mode> nonRestrictModes,
      BaseClientDetails client,
      String s) {
