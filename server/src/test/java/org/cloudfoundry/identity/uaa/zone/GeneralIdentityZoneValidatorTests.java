...
import static org.cloudfoundry.identity.uaa.zone.IdentityZoneValidator.Mode.*;
...
public class GeneralIdentityZoneValidatorTests {
  ...
  GeneralIdentityZoneConfigurationValidator zoneConfigurationValidator =
      mock(GeneralIdentityZoneConfigurationValidator.class);
  GeneralIdentityZoneValidator validator =
      new GeneralIdentityZoneValidator(zoneConfigurationValidator);

  @Test
  public void validate_right_mode()
      throws InvalidIdentityZoneDetailsException, InvalidIdentityZoneConfigurationException {
  ...
  @Test
  public void other_zone_inactive_succeeds()
