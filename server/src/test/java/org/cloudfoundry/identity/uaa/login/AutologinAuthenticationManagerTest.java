...
public class AutologinAuthenticationManagerTest {
  ...
  public void setUp() {
    ...
    UaaAuthenticationDetails details =
        new UaaAuthenticationDetails(new MockHttpServletRequest(), clientId);
  ...
  public void authentication_successful() throws Exception {
    ...
    when(clientDetailsService.loadClientByClientId(eq(clientId), anyString()))
        .thenReturn(new BaseClientDetails("test-client-details", "", "", "", ""));
    ...
    UaaAuthenticationDetails uaaAuthDetails =
        (UaaAuthenticationDetails) uaaAuthentication.getDetails();
