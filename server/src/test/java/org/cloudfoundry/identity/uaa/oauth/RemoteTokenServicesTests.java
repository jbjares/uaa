...
public class RemoteTokenServicesTests {
  ...
  public void testTokenRetrievalWithAdditionalAuthorizationAttributes() throws Exception {
    ...
    assertNotNull(result);
    assertEquals(
        JsonUtils.writeValueAsString(additionalAuthorizationAttributesMap),
        result.getOAuth2Request().getRequestParameters().get(ClaimConstants.ADDITIONAL_AZ_ATTR));
  }
}
