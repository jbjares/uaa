...
/**
 * Simple implementation of {@link ProfileValueSource} that returns an empty String instead of a
 * null value if the property is missing, and otherwise gets it from System properties.
 *
 * @author Dave Syer
 */
