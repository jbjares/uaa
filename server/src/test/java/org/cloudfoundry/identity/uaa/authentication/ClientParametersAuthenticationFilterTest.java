...
public class ClientParametersAuthenticationFilterTest {
  ...
  @Test
  public void doesNotContinueWithFilterChain_IfAuthenticationException()
    ...
    when(clientAuthenticationManager.authenticate(Mockito.any()))
    ...
    verify(authenticationEntryPoint)
        .commence(
            any(request.getClass()), any(response.getClass()), any(BadCredentialsException.class));
