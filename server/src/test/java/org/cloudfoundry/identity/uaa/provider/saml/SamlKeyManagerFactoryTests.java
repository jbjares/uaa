...
public class SamlKeyManagerFactoryTests {
  ...
  public void multiple_keys_legacy_is_active_key() {
    ...
    assertThat(
        manager.getAvailableCredentials(),
        containsInAnyOrder(SamlConfig.LEGACY_KEY_ID, "key-1", "key-2"));
  }
  ...
  public void add_active_key() {
    ...
    assertThat(
        manager.getAvailableCredentials(),
        containsInAnyOrder(SamlConfig.LEGACY_KEY_ID, "key-1", "key-2", alias));
  }
  ...
  public void keystore_impls_is_not_a_singleton() throws KeyStoreException {
    ...
    KeyStore ks1 =
        (KeyStore) ReflectionTestUtils.getField(manager1, JKSKeyManager.class, "keyStore");
    KeyStore ks2 =
        (KeyStore) ReflectionTestUtils.getField(manager2, JKSKeyManager.class, "keyStore");
