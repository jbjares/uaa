...
public class ChainedAuthenticationManagerTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    when(authenticateThrow.authenticate(any(Authentication.class)))
        .thenThrow(new BadCredentialsException("mock throw"));
    ...
    managers[1] =
        new ChainedAuthenticationManager.AuthenticationManagerConfiguration(
            null, ChainedAuthenticationManager.IF_PREVIOUS_FALSE);
    managers[2] =
        new ChainedAuthenticationManager.AuthenticationManagerConfiguration(
            loginAuthenticationManager, ChainedAuthenticationManager.IF_PREVIOUS_TRUE);
