...
public class SecurityFilterChainPostProcessorTests {
  ...
  private Map<SecurityFilterChainPostProcessor.FilterPosition, Filter> additionalFilters =
      new HashMap<>();
  private int count;
  ...
  private void testPositionFilter(int pos) {
    ...
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.position(pos), new PositionFilter());
    ...
    assertTrue(
        "filter[" + pos + "] should be:" + PositionFilter.class.getSimpleName(),
        fc.getFilters().get(expectedPos).getClass().equals(PositionFilter.class));
  }
  ...
  private void testClassPlacementFilter(Class<?> clazz, int expectedPosition) throws Exception {
    ...
    assertEquals(count + 1, fc.getFilters().size());
    assertTrue(
        "filter[" + clazz.getSimpleName() + "] should be at position:" + expectedPosition,
        fc.getFilters().get(expectedPosition).getClass().equals(clazz));
  }

  @Test
  public void testBeforePlacement1() throws Exception {
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.before(TestFilter1.class),
        new BeforeFilter());
  ...
  public void testBeforePlacement2() throws Exception {
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.before(TestFilter2.class),
        new BeforeFilter());
  ...
  public void testBeforePlacement3() throws Exception {
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.before(TestFilter3.class),
        new BeforeFilter());
  ...
  public void testBeforePlacementWhenMissing() throws Exception {
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.before(PositionFilter.class),
        new BeforeFilter());
  ...
  public void testAfterPlacement1() throws Exception {
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.after(TestFilter1.class),
        new AfterFilter());
  ...
  public void testAfterPlacement2() throws Exception {
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.after(TestFilter2.class),
        new AfterFilter());
  ...
  public void testAfterPlacement3() throws Exception {
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.after(TestFilter3.class),
        new AfterFilter());
  ...
  public void testAfterPlacementWhenMissing() throws Exception {
    additionalFilters.put(
        SecurityFilterChainPostProcessor.FilterPosition.after(PositionFilter.class),
        new AfterFilter());
