...
import static org.cloudfoundry.identity.uaa.provider.SamlIdentityProviderDefinition.MetadataLocation.*;
...
public class SamlIdentityProviderDefinitionTests {
  ...
  public void test_serialize_custom_attributes_field() {
    ...
    SamlIdentityProviderDefinition def =
        JsonUtils.readValue(
            JsonUtils.writeValueAsString(definition), SamlIdentityProviderDefinition.class);
  ...
  public void testGetType() throws Exception {
    ...
    File f =
        new File(
            ...
            SamlIdentityProviderDefinitionTests.class.getName() + ".testcase");
    f.createNewFile();
    f.deleteOnExit();
  ...
  public void test_XML_with_DOCTYPE_Fails() {
    definition.setMetaDataLocation(
        IDP_METADATA.replace("<?xml version=\"1.0\"?>\n", "<?xml version=\"1.0\"?>\n<!DOCTYPE>"));
