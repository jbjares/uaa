...
public class ExternalLoginAuthenticationManagerTest {
  ...
  public void testAuthenticateWithAuthDetails() throws Exception {
    ...
    when(uaaAuthenticationDetails.getSessionId())
        .thenReturn(new RandomValueStringGenerator().generate());
  ...
  public void testAuthenticateUserInsertFails() throws Exception {
    when(uaaUserDatabase.retrieveUserByName(anyString(), anyString()))
  ...
  public void testAuthenticateInvitedUserWithoutAcceptance() throws Exception {
    ...
    when(invitedUser.modifyAttributes(
  ...
  public void testPopulateAttributesStoresCustomAttributesAndRoles() {
    ...
    ExternalIdentityProviderDefinition providerDefinition =
        new ExternalIdentityProviderDefinition();
  ...
  public void testAuthenticateUserExists() throws Exception {
    ...
    IdentityProviderAuthenticationSuccessEvent userevent =
        (IdentityProviderAuthenticationSuccessEvent) userArgumentCaptor.getAllValues().get(0);
