...
class IdentityZoneHolderTest {
    ...
    void getSamlSPKeyManager() {
      KeyManager expected =
          SamlKeyManagerFactory.getKeyManager(
              IdentityZoneHolder.getUaaZone().getConfig().getSamlConfig());
  ...
  class WhenZoneIsNotUaa {
    ...
    void getSamlSPKeyManager() {
      ...
      IdentityZoneConfiguration mockIdentityZoneConfiguration =
          mock(IdentityZoneConfiguration.class);
      ...
      assertThat(
          actual.getDefaultCredential().getPrivateKey().getEncoded(),
