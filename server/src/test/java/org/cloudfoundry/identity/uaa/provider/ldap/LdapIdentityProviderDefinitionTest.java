...
public class LdapIdentityProviderDefinitionTest {
  ...
  public void testEquals() {
    LdapIdentityProviderDefinition ldapIdentityProviderDefinition1 =
        new LdapIdentityProviderDefinition();
    ldapIdentityProviderDefinition1.setAddShadowUserOnLogin(true);
    LdapIdentityProviderDefinition ldapIdentityProviderDefinition2 =
        new LdapIdentityProviderDefinition();
  ...
  public void test_serialization_of_tls_attribute() {
    ...
    LdapIdentityProviderDefinition deserialized =
        JsonUtils.readValue(config, LdapIdentityProviderDefinition.class);
  ...
  public void testSearchAndBindConfiguration() throws Exception {
    ...
    LdapIdentityProviderDefinition deserialized2 =
        JsonUtils.readValue(config, LdapIdentityProviderDefinition.class);
  ...
  public void test_Simple_Bind_Config() throws Exception {
    ...
    assertEquals(
        "cn={0},ou=Users,dc=test,dc=com;cn={0},ou=OtherUsers,dc=example,dc=com",
        def.getUserDNPattern());
  ...
  @Test
  public void test_Search_and_Compare_With_Groups_1_Config_And_Custom_Attributes()
      throws Exception {
    String config =
        "ldap:\n"
            + "  profile:\n"
  ...
  public void testSetEmailDomain() {
    ...
    def =
        JsonUtils.readValue(
            JsonUtils.writeValueAsString(def), LdapIdentityProviderDefinition.class);
    assertEquals("test.com", def.getEmailDomain().get(0));
  }
