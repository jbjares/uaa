...
public class GeneralIdentityZoneConfigurationValidatorTests {
  ...
  public static Object[][] parameters() {
    return new Object[][] {
      {IdentityZoneValidator.Mode.CREATE}, {IdentityZoneValidator.Mode.MODIFY}
    };
  }
  ...
  @Test
  public void validate_with_invalid_active_key_id()
    ...
    expection.expectMessage(
        "Invalid SAML active key ID: 'wrong'. Couldn't find any matching keys.");
    validator.validate(zone, mode);
  }

  @Test
  public void validate_with_invalid_consent_link()
      throws InvalidIdentityZoneConfigurationException {
    zone.getConfig().getBranding().setConsent(new Consent("some text", "some-invalid-link"));

    expection.expect(InvalidIdentityZoneConfigurationException.class);
    expection.expectMessage(
        "Invalid consent link: some-invalid-link. Must be a properly formatted URI beginning with http:// or https://");
    validator.validate(zone, mode);
  }

  @Test
  public void validateConsent_withNotNullTextAndNullLink()
      throws InvalidIdentityZoneConfigurationException {
  ...
  @Test
  public void validateConsent_withNullTextAndNotNullLink()
      throws InvalidIdentityZoneConfigurationException {
  ...
  @Test
  public void validateConsent_withNullTextAndNullLink()
      throws InvalidIdentityZoneConfigurationException {
  ...
  @Test
  public void validate_without_legacy_key_and_null_active_key()
      throws InvalidIdentityZoneConfigurationException {
    samlConfig.setKeys(EMPTY_MAP);
    assertNull(samlConfig.getActiveKeyId());
    samlConfig.addKey("key-1", new SamlKey(key1, passphrase1, certificate1));
  ...
  public void mfa_validation_exception_gets_thrown_back() throws Exception {
    ...
    doThrow(new InvalidIdentityZoneConfigurationException("Invalid MFA Config"))
        .when(mfaConfigValidator)
        .validate(any(), any());
