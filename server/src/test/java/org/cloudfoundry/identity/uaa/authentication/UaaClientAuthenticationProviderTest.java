...
public class UaaClientAuthenticationProviderTest extends JdbcTestBase {
  ...
  public void setUpForClientTests() {
    ...
    ClientDetailsUserDetailsService clientDetailsService =
        new ClientDetailsUserDetailsService(jdbcClientDetailsService);
    client = createClient();
  ...
  public BaseClientDetails createClient() {
    BaseClientDetails details =
        new BaseClientDetails(generator.generate(), "", "", "client_credentials", "uaa.resource");
  ...
  public void provider_authenticate_client_with_two_passwords_test_1() throws Exception {
    jdbcClientDetailsService.addClientSecret(
        client.getClientId(), "secret2", IdentityZoneHolder.get().getId());
