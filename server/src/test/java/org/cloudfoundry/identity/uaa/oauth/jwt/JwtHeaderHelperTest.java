...
class JwtHeaderHelperTest {
  ...
  class JWS {
    ...
    void createFromStringThrowsExceptionWhenTypeIsNotJWT() {
      ...
      Exception exception =
          Assertions.assertThrows(
              Exception.class, () -> JwtHeaderHelper.create(asBase64(objectNode.toString())));
    ...
    class OptionalHeaders {
      ...
      @DisplayName(
          "should deserialize when provided optional enc/iv claims. "
      ...
      void shouldAllowCritHeader() {
        objectNode.putArray("crit").add("first-val").add("value-2");
