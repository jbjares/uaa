...
public class UaaAuthenticationDetailsTest {
  ...
  public void testToStringDoesNotContainSessionId() {
    UaaAuthenticationDetails details =
        new UaaAuthenticationDetails(false, "clientid", "origin", "1234");
  ...
  public void testBuildValidAuthenticationDetails()
    ...
    request.addHeader(
        "Authorization", "Basic " + new String(Base64.getEncoder().encode("a:".getBytes())));
  ...
  public void testBuildInvalidAuthenticationDetails()
    ...
    MockHttpServletRequest request = new MockHttpServletRequest();
    request.addHeader(
        "Authorization", "Basic " + new String(Base64.getEncoder().encode(":".getBytes())));
