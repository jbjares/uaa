...
public class UsernamePasswordExtractingAuthenticationManagerTests {
  ...
  private UsernamePasswordExtractingAuthenticationManager manager =
      new UsernamePasswordExtractingAuthenticationManager(delegate);
  ...
  public void testAuthenticate() {
    Authentication expected =
        new TestingAuthenticationToken(
            "bar", "foo", AuthorityUtils.commaSeparatedStringToAuthorityList("USER"));
    Mockito.when(
            delegate.authenticate(ArgumentMatchers.any(UsernamePasswordAuthenticationToken.class)))
        .thenReturn(expected);
