...
public class ClientAdminEndpointsValidatorTests {
  ...
  public void createClient() throws Exception {
    ...
    QueryableResourceManager<ClientDetails> clientDetailsService =
        mock(QueryableResourceManager.class);
  ...
  public void testValidate_Should_Allow_Prefix_Names() throws Exception {
    ...
    client.setAuthorities(
        Arrays.asList(new SimpleGrantedAuthority(caller.getClientId() + ".some.other.authority")));
  ...
  public void test_validate_not_permits_restricted_urls_for_authcode_implicit_grant_types() {
    ...
    for (String s :
        Arrays.asList(new String[] {GRANT_TYPE_AUTHORIZATION_CODE, GRANT_TYPE_IMPLICIT})) {
