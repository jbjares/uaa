...
public class UserManagedAuthzApprovalHandlerTests extends JdbcTestBase {
  ...
  public void initUserManagedAuthzApprovalHandlerTests() {
    ...
    handler.setClientDetailsService(
        mockClientDetailsService(
            "foo",
            new String[] {
              "cloud_controller.read", "cloud_controller.write", "openid", "space.*.developer"
            },
  ...
  private QueryableResourceManager<ClientDetails> mockClientDetailsService(
      String id, String[] scope, Set<String> autoApprovedScopes) {
  ...
  public void testNoScopeApproval() {
    AuthorizationRequest request =
        new AuthorizationRequest("testclient", Collections.<String>emptySet());
  ...
  public void testNoPreviouslyApprovedScopes() {
    AuthorizationRequest request =
        new AuthorizationRequest(
            "foo", new HashSet<>(Arrays.asList("cloud_controller.read", "cloud_controller.write")));
  ...
  public void testRequestedScopesDontMatchApprovalsAtAll() {
    AuthorizationRequest request =
        new AuthorizationRequest("foo", new HashSet<>(Arrays.asList("openid")));
    request.setApproved(false);
  ...
  public void testOnlySomeRequestedScopeMatchesApproval() {
    AuthorizationRequest request =
        new AuthorizationRequest(
            "foo", new HashSet<>(Arrays.asList("openid", "cloud_controller.read")));
    request.setApproved(false);
  ...
  public void testOnlySomeRequestedScopeMatchesDeniedApprovalButScopeAutoApproved() {
    ...
    handler.setClientDetailsService(
        mockClientDetailsService(
            "foo",
            new String[] {"cloud_controller.read", "cloud_controller.write", "openid"},
            singleton("true")));
    ...
    assertTrue(handler.isApproved(request, userAuthentication));
    assertEquals(
        new HashSet<>(Arrays.asList(new String[] {"cloud_controller.read", "openid"})),
        request.getScope());
  }
  ...
  public void testRequestedScopesMatchApprovalButAdditionalScopesRequested() {
    AuthorizationRequest request =
        new AuthorizationRequest(
            "foo",
            new HashSet<>(
                Arrays.asList("openid", "cloud_controller.read", "cloud_controller.write")));
    request.setApproved(false);
  ...
  public void testAllRequestedScopesMatchApproval() {
    ...
    assertEquals(
        new HashSet<>(
            Arrays.asList(
                new String[] {"openid", "cloud_controller.read", "cloud_controller.write"})),
        request.getScope());
  }
  ...
  public void testRequestedScopesMatchApprovalButSomeDenied() {
    ...
    assertTrue(handler.isApproved(request, userAuthentication));
    assertEquals(
        new HashSet<>(Arrays.asList(new String[] {"openid", "cloud_controller.read"})),
        request.getScope());
  }
  ...
  public void testRequestedScopesMatchByWildcard() {
    ...
    assertThat(
        ...
        Matchers.containsInAnyOrder(
            new String[] {
              "openid", "cloud_controller.read", "cloud_controller.write", "space.1.developer"
            }));
  }
  ...
  public void cleanupDataSource() throws Exception {
    ...
    assertThat(
        jdbcTemplate.queryForObject("select count(*) from authz_approvals", Integer.class), is(0));
  }
