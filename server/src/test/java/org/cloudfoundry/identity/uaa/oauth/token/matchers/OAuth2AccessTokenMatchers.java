...
public class OAuth2AccessTokenMatchers
    extends AbstractOAuth2AccessTokenMatchers<OAuth2AccessToken> {
  ...
  protected void describeMismatchSafely(
      OAuth2AccessToken accessToken, Description mismatchDescription) {
    if (accessToken != null) {
      Map<String, Object> claims = getClaims(accessToken);
