...
public class GeneralMfaProviderValidatorTest {
  ...
  public void validateProviderNullConfig() throws ValidationException {
    ...
    MfaProvider<GoogleMfaProviderConfig> provider = createValidGoogleMfaProvider().setConfig(null);
  ...
  public void validateProviderConfigWithMissingIssuer() throws ValidationException {
    MfaProvider<GoogleMfaProviderConfig> provider =
        createValidGoogleMfaProvider().setConfig(createValidGoogleMfaConfig().setIssuer(null));
    validator.validate(provider);
  }
  ...
  public void validateProviderEmptyName() throws ValidationException {
    ...
    MfaProvider provider = createValidGoogleMfaProvider().setName("");
    validator.validate(provider);
  }
  ...
  public void validateProviderInvalidNameTooLong() throws ValidationException {
    ...
    MfaProvider provider =
        createValidGoogleMfaProvider().setName(new RandomValueStringGenerator(257).generate());
    validator.validate(provider);
  }
  ...
  public void validateProviderWhitespaceInName() {
    ...
    MfaProvider provider = createValidGoogleMfaProvider().setName(name);
    validator.validate(provider);
  }
  ...
  public void validateProviderInvalidNameSpecialChars() throws ValidationException {
    ...
    MfaProvider provider = createValidGoogleMfaProvider().setName("invalidName$");
    validator.validate(provider);
  }
  ...
  public void validateProviderNullType() throws ValidationException {
    ...
    MfaProvider provider = createValidGoogleMfaProvider().setType(null);
    validator.validate(provider);
  }
  ...
  public void validateProviderEmptyZone() throws ValidationException {
    ...
    MfaProvider provider = createValidGoogleMfaProvider().setIdentityZoneId("");
    validator.validate(provider);
  }
