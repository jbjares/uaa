...
public class HomeControllerViewTests extends TestClassNullifier {
  ...
  private static final String base64ProductLogo =
      "D44vIpdmc0ne8IPLEbYD2vvLpu71spjxwaLYYdj39gTYa9kyWs";
  @Autowired WebApplicationContext webApplicationContext;

  @Autowired MockEnvironment environment;
  ...
  public void tilesFromClientMetadataAndTilesConfigShown() throws Exception {
    mockMvc
        ...
        .andExpect(
            xpath("//head/style[2]")
                .string(
                    ".tile-1 .tile-icon {background-image: url(\"data:image/png;base64,"
                        + base64EncodedImg
                        + "\")}"))
