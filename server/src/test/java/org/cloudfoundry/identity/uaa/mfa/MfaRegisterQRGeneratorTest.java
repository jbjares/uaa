...
public class MfaRegisterQRGeneratorTest {
  ...
  public void testQRCode() throws Exception {
    ...
    String encodedQrCode =
        MfaRegisterQRGenerator.getQRCode("testIssuer", "accountName", key.getKey());
  ...
  public void testQrWithSpecialChars() throws Exception {
    ...
    GoogleAuthenticatorKey key = authenticator.createCredentials();
    String encodedQrCode =
        MfaRegisterQRGenerator.getQRCode("test=Issuer", "account?&#Name", key.getKey());
    String result = decodeQrPng(encodedQrCode);
  ...
  public void testQrWithColonIssuer() throws Exception {
    ...
    GoogleAuthenticatorKey key = authenticator.createCredentials();
    String encodedQrCode =
        MfaRegisterQRGenerator.getQRCode("test:Issuer", "accountName", key.getKey());
  }
  ...
  public void testPngUrl() throws Exception {
    ...
    GoogleAuthenticatorKey key = authenticator.createCredentials();
    String encodedQrCode =
        MfaRegisterQRGenerator.getQRCodePngDataUri("testIssuer", "accountName", key.getKey());
  ...
  private String decodeQrPng(String encodedQrCode)
