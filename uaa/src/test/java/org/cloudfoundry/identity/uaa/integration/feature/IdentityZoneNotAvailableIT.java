...
public class IdentityZoneNotAvailableIT {
  ...
  public void setUp() throws Exception {
    ...
    ClientCredentialsResourceDetails adminResource =
        IntegrationTestUtils.getClientCredentialsResource(baseUrl, scope, "admin", "adminsecret");
    restTemplate = IntegrationTestUtils.getClientCredentialsTemplate(adminResource);
  ...
  private void checkNotFoundForEndpoint(HttpMethod method, String endpoint) {
    ResponseEntity<Void> forEntity =
        restTemplate.exchange(
            endpoint, method, new HttpEntity<Void>(null, new HttpHeaders()), Void.class);
