...
public class MfaPasswordGrantMockMvcTests extends AbstractTokenMockMvcTests {
  ...
  @Autowired private StatelessMfaAuthenticationFilter statelessMfaAuthenticationFilter;
  ...
  void filter_only_triggers_on_password_grant() {
    assertThat(
        statelessMfaAuthenticationFilter.getSupportedGrantTypes(), containsInAnyOrder("password"));
  }
  ...
  void mfa_happy_path() throws Exception {
    ...
    validateAuthEvents(asList(MfaAuthenticationSuccessEvent.class), "marissa");
  }

  private void validateAuthEvents(
      List<Class<? extends AbstractUaaAuthenticationEvent>> eventsExpected, String username) {
  ...
  void invalid_code() throws Exception {
    ...
    validateAuthEvents(asList(MfaAuthenticationFailureEvent.class), "marissa");
  }
