...
public class ResetPasswordIT {
  ...
  public void setUp() throws Exception {
    ...
    BaseClientDetails authCodeClient =
  ...
  public void resetPassword_with_clientRedirect() throws Exception {
    ...
    assertEquals(
        baseUrl + "/login?success=password_reset&form_redirect_uri=http://example.redirect.com",
  ...
  public void testNotAutoLoginAfterResetPassword() {
    webDriver.get(
        baseUrl
            ...
            + authCodeClientId
            + "&redirect_uri=http://example.redirect.com&grant_type=authorization_code&response_type=code");
    //        webDriver.get();
    ...
    assertThat(
        ...
        containsString("Password reset successful"));
    webDriver.findElement(By.name("username")).sendKeys(username);
    webDriver.findElement(By.name("password")).sendKeys("new_password");
  ...
  public void resettingAPasswordWithInvalidPassword() throws Exception {
    ...
    webDriver.findElement(By.xpath("//input[@value='Create new password']")).click();
    assertThat(
        webDriver.findElement(By.cssSelector(".error-message")).getText(),
