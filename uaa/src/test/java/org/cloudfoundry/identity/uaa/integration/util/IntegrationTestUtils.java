...
public class IntegrationTestUtils {
  ...
  public static void updateUserToForcePasswordChange(
      RestTemplate restTemplate, String baseUrl, String adminToken, String userId) {
    updateUserToForcePasswordChange(restTemplate, baseUrl, adminToken, userId, null);
  }

  public static void updateUserToForcePasswordChange(
      RestTemplate restTemplate, String baseUrl, String adminToken, String userId, String zoneId) {
    ...
    ResponseEntity<UserAccountStatus> response =
        restTemplate.exchange(
            baseUrl + "/Users/{user-id}/status",
            HttpMethod.PATCH,
            new HttpEntity<UserAccountStatus>(userAccountStatus, headers),
  ...
  public static UserInfoResponse getUserInfo(String url, String token) throws URISyntaxException {
    ...
    RequestEntity<Void> request =
        new RequestEntity<>(headers, HttpMethod.GET, new URI(url + "/userinfo"));
    return rest.exchange(request, UserInfoResponse.class).getBody();
  }

  public static void deleteZone(String baseUrl, String id, String adminToken)
    ...
    headers.add(ACCEPT, APPLICATION_JSON_VALUE);
    RequestEntity<Void> request =
        new RequestEntity<>(headers, HttpMethod.DELETE, new URI(baseUrl + "/identity-zones/" + id));
    rest.exchange(request, Void.class);
  }

  public static MfaProvider createGoogleMfaProvider(
      String url,
      String token,
      MfaProvider<GoogleMfaProviderConfig> provider,
      String zoneSwitchId) {
    ...
    ResponseEntity<MfaProvider> providerResponse =
        template.exchange(url + "/mfa-providers", HttpMethod.POST, getHeaders, MfaProvider.class);
  ...
  public static final DefaultResponseErrorHandler fiveHundredErrorHandler =
  ...
  public static boolean doesSupportZoneDNS() {
    try {
      return Arrays.equals(
          ...
          && Arrays.equals(
              Inet4Address.getByName("testzone3.localhost").getAddress(), new byte[] {127, 0, 0, 1})
          && Arrays.equals(
              Inet4Address.getByName("testzone4.localhost").getAddress(), new byte[] {127, 0, 0, 1})
          && Arrays.equals(
              Inet4Address.getByName("testzonedoesnotexist.localhost").getAddress(),
              new byte[] {127, 0, 0, 1})
          && Arrays.equals(
              Inet4Address.getByName("testzoneinactive.localhost").getAddress(),
              new byte[] {127, 0, 0, 1});
  ...
  public static ClientCredentialsResourceDetails getClientCredentialsResource(
      String url, String[] scope, String clientId, String clientSecret) {
  ...
  public static RestTemplate getClientCredentialsTemplate(
    ...
    client.setErrorHandler(
        new OAuth2ErrorHandler(details) {
  ...
  public static ScimUser createUser(
      RestTemplate client,
      String url,
      String username,
      String firstName,
  ...
  public static ScimUser createUserWithPhone(
      RestTemplate client,
      String url,
      String username,
      String firstName,
  ...
  public static ScimUser createUser(String token, String url, ScimUser user, String zoneSwitchId) {
    ...
    ResponseEntity<ScimUser> userInfoGet =
        template.exchange(url + "/Users", HttpMethod.POST, getHeaders, ScimUser.class);
  ...
  public static ScimUser updateUser(String token, String url, ScimUser user) {
    ...
    ResponseEntity<ScimUser> userInfoGet =
        template.exchange(
            url + "/Users/" + user.getId(), HttpMethod.PUT, getHeaders, ScimUser.class);
  ...
  public static ScimUser getUserByZone(
      String token, String url, String subdomain, String username) {
    RestTemplate template = new RestTemplate();
    MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
    headers.add("Accept", APPLICATION_JSON_VALUE);
    headers.add("Authorization", "bearer " + token);
    ...
    ResponseEntity<String> userInfoGet =
        template.exchange(
    ...
    if (userInfoGet.getStatusCode() == HttpStatus.OK) {
      ...
      SearchResults<ScimUser> results =
          JsonUtils.readValue(userInfoGet.getBody(), SearchResults.class);
  ...
  public static ScimUser getUser(String token, String url, String userId) {
    ...
    HttpEntity getHeaders = new HttpEntity(headers);
    ResponseEntity<ScimUser> userInfoGet =
        template.exchange(url + "/Users/" + userId, HttpMethod.GET, getHeaders, ScimUser.class);
    if (userInfoGet.getStatusCode() == HttpStatus.OK) {
      return userInfoGet.getBody();
    }
    throw new RuntimeException("Invalid return code:" + userInfoGet.getStatusCode());
  ...
  public static String getUserIdByField(
      String token, String url, String origin, String field, String fieldValue) {
    RestTemplate template = new RestTemplate();
    MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
    headers.add("Accept", APPLICATION_JSON_VALUE);
    headers.add("Authorization", "bearer " + token);
  ...
  public static void deleteUser(String zoneAdminToken, String url, String userId) {
    ...
    ResponseEntity<String> userDelete =
        template.exchange(url + "/Users/" + userId, HttpMethod.DELETE, deleteHeaders, String.class);
  ...
  public static Map findAllGroups(RestTemplate client, String url) {
  ...
  public static String findGroupId(RestTemplate client, String url, String groupName) {
  ...
  public static ScimGroup getGroup(RestTemplate client, String url, String groupName) {
    ...
    if (id != null) {
      ResponseEntity<ScimGroup> group =
          client.getForEntity(url + "/Groups/{id}", ScimGroup.class, id);
  ...
  public static ScimGroup createOrUpdateGroup(
      RestTemplate client, String url, ScimGroup scimGroup) {
  ...
  public static ScimGroup getGroup(String token, String zoneId, String url, String displayName) {
    ...
    ResponseEntity<SearchResults<ScimGroup>> findGroup =
        template.exchange(
  ...
  public static ScimGroup createGroup(String token, String zoneId, String url, ScimGroup group) {
    ...
    ResponseEntity<ScimGroup> createGroup =
        template.exchange(
            url + "/Groups",
            HttpMethod.POST,
  ...
  public static ScimGroup updateGroup(String token, String zoneId, String url, ScimGroup group) {
    ...
    ResponseEntity<ScimGroup> updateGroup =
        template.exchange(
            url + "/Groups/{groupId}",
            HttpMethod.PUT,
            new HttpEntity(JsonUtils.writeValueAsBytes(group), headers),
  ...
  public static ScimGroup createOrUpdateGroup(
      String token, String zoneId, String url, ScimGroup scimGroup) {
  ...
  public static ScimGroupExternalMember mapExternalGroup(
      String token, String zoneId, String url, ScimGroupExternalMember scimGroup) {
    ...
    ResponseEntity<ScimGroupExternalMember> mapGroup =
        template.exchange(
            url + "/Groups/External",
            HttpMethod.POST,
  ...
  public static void deleteGroup(String token, String zoneId, String url, String groupId) {
    RestTemplate template = new RestTemplate();
    template.setErrorHandler(fiveHundredErrorHandler);
    MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
    headers.add("Authorization", "bearer " + token);
  ...
  private static IdentityZone createZoneOrUpdateSubdomain(
      RestTemplate client,
      String url,
      String id,
      String subdomain,
    ...
    ResponseEntity<String> zoneGet =
        client.getForEntity(url + "/identity-zones/{id}", String.class, id);
    ...
    if (zoneGet.getStatusCode() == HttpStatus.OK) {
      ...
      ResponseEntity<String> getUpdatedZone =
          client.exchange(
              url + "/identity-zones/{id}", HttpMethod.PUT, updateZoneRequest, String.class, id);
    ...
    IdentityZone identityZone =
        new IdentityZone()
            ...
            .setConfig(config)
            .setActive(active);
    ResponseEntity<IdentityZone> zone =
        client.postForEntity(url + "/identity-zones", identityZone, IdentityZone.class);
    return zone.getBody();
  }
  ...
  public static IdentityZone createInactiveIdentityZone(RestTemplate client, String url) {
    createZoneOrUpdateSubdomain(
        ...
        false);
    ResponseEntity<IdentityZone> zoneGet =
        client.getForEntity(url + "/identity-zones/{id}", IdentityZone.class, "testzoneinactive");
    if (!(zoneGet.getStatusCode() == HttpStatus.OK)) {
  ...
  public static IdentityZone createZoneOrUpdateSubdomain(
      RestTemplate client,
      String url,
      String id,
      String subdomain,
  ...
  public static void addMemberToGroup(
      RestTemplate client, String url, String userId, String groupId) {
    ScimGroupMember groupMember = new ScimGroupMember(userId);
    ResponseEntity<String> response =
        client.postForEntity(url + "/Groups/{groupId}/members", groupMember, String.class, groupId);
    assertEquals(HttpStatus.CREATED, response.getStatusCode());
  }

  public static BaseClientDetails getClient(String token, String url, String clientId) {
    RestTemplate template = new RestTemplate();
    MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
    headers.add("Accept", APPLICATION_JSON_VALUE);
    headers.add("Authorization", "bearer " + token);
    ...
    ResponseEntity<BaseClientDetails> response =
        template.exchange(
  ...
  public static BaseClientDetails createClientAsZoneAdmin(
      String zoneAdminToken, String url, String zoneId, BaseClientDetails client) throws Exception {
    ...
    ResponseEntity<String> clientCreate =
        template.exchange(url + "/oauth/clients", HttpMethod.POST, getHeaders, String.class);
  ...
  public static BaseClientDetails createClient(
      String adminToken, String url, BaseClientDetails client) throws Exception {
    return createOrUpdateClient(adminToken, url, null, client);
  }

  public static BaseClientDetails createOrUpdateClient(
      String adminToken, String url, String switchToZoneId, BaseClientDetails client)
      throws Exception {
    ...
    if (clientCreate.getStatusCode() == HttpStatus.CREATED) {
      ...
      ResponseEntity<String> clientUpdate =
          template.exchange(
  ...
  public static BaseClientDetails updateClient(String url, String token, BaseClientDetails client)
      throws Exception {
  ...
  public static IdentityProvider getProvider(
      String zoneAdminToken, String url, String zoneId, String originKey) {
  ...
  public static List<IdentityProvider> getProviders(
    ...
    ResponseEntity<String> providerGet =
        client.exchange(url + "/identity-providers", HttpMethod.GET, getHeaders, String.class);
    if (providerGet != null && providerGet.getStatusCode() == HttpStatus.OK) {
      return JsonUtils.readValue(
          providerGet.getBody(), new TypeReference<List<IdentityProvider>>() {});
    }
    return null;
  }
   ...
   * @param addShadowUserOnLogin Specifies whether UAA should automatically create shadow users upon
  ...
  public static IdentityProvider createIdentityProvider(
      String originKey, boolean addShadowUserOnLogin, String baseUrl, ServerRunning serverRunning)
      throws Exception {
    ...
    SamlIdentityProviderDefinition samlIdentityProviderDefinition =
        createSimplePHPSamlIDP(originKey, OriginKeys.UAA);
    return createIdentityProvider(
        "simplesamlphp for uaa",
  ...
  public static IdentityProvider createOidcIdentityProvider(
      String name, String originKey, String baseUrl) throws Exception {
    IdentityProvider<AbstractXOAuthIdentityProviderDefinition> identityProvider =
  ...
  public static IdentityProvider createOrUpdateProvider(
      String accessToken, String url, IdentityProvider provider) {
    RestTemplate client = new RestTemplate();
    MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
    headers.add("Accept", APPLICATION_JSON_VALUE);
  ...
  public static String getClientCredentialsToken(
    ...
    headers.set(
        "Authorization",
        "Basic "
            + new String(Base64.encode(String.format("%s:%s", clientId, clientSecret).getBytes())));
  ...
  public static Map<String, Object> getPasswordToken(
      String baseUrl,
      String clientId,
      String clientSecret,
      String username,
    ...
    template
        ...
        .add(0, new StringHttpMessageConverter(java.nio.charset.Charset.forName("UTF-8")));
    template.setRequestFactory(new StatelessRequestFactory());
    MultiValueMap<String, String> formData = new LinkedMultiValueMap<>();
  ...
  public static String getClientCredentialsToken(
      ServerRunning serverRunning, String clientId, String clientSecret) throws Exception {
  ...
  public static String getAccessTokenByAuthCode(
      ServerRunning serverRunning,
    ...
    return getAuthorizationCodeTokenMap(
            serverRunning, testAccounts, clientId, clientSecret, username, password)
        .get("access_token");
  }
  ...
  public static Map<String, String> getAuthorizationCodeTokenMap(
    ...
    ServerRunning.UriBuilder builder =
        serverRunning
      ...
      for (String header : result.getHeaders().get("Set-Cookie")) {
        ...
        cookies.addCookie(
            new BasicClientCookie(
                header.substring(0, nameLength), header.substring(nameLength + 1)));
      }
    }
    ...
    if (response.getHeaders().containsKey("Set-Cookie")) {
      for (String cookie : response.getHeaders().get("Set-Cookie")) {
        ...
        cookies.addCookie(
            new BasicClientCookie(
                cookie.substring(0, nameLength), cookie.substring(nameLength + 1)));
      }
    }
    ...
    if (response.getStatusCode() == HttpStatus.OK) {
      ...
      formData.add(
          DEFAULT_CSRF_COOKIE_NAME, IntegrationTestUtils.extractCookieCsrf(response.getBody()));
  ...
  public static String createAnotherUser(
      WebDriver webDriver,
      String password,
