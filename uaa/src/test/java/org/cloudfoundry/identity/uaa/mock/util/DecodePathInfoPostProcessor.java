...
/** Works around a bug in Spring Framework Mock MVC Tests that double encodes % */
public class DecodePathInfoPostProcessor implements RequestPostProcessor {
   ...
   *
   * <p>The default implementation checks the request encoding, falling back to {@code
