  ...
  void getWellKnownOpenidConf() throws Exception {
    ...
    Snippet responseFields =
        responseFields(
            ...
            fieldWithPath("token_endpoint_auth_methods_supported")
                .description(
            ...
            fieldWithPath("id_token_signing_alg_values_supported")
                .description(
                    "JSON array containing a list of the JWS signing algorithms (alg values) supported by the OP for the ID Token to encode the Claims in a JWT."),
            fieldWithPath("id_token_encryption_alg_values_supported")
                .description(
                    "JSON array containing a list of the JWE encryption algorithms (alg values) supported by the OP."),
            fieldWithPath("claim_types_supported")
                .description(
            ...
            fieldWithPath("ui_locales_supported")
    ...
    mockMvc
        ...
        .andDo(
            document(
                "{ClassName}/{methodName}", preprocessResponse(prettyPrint()), responseFields));
  }
}
