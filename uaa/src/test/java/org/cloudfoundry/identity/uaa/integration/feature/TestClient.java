...
public class TestClient {
  ...
  public String getOAuthAccessToken(
      String baseUrl, String username, String password, String grantType, String scope) {
    ...
    ResponseEntity<Map> exchange =
        restTemplate.exchange(baseUrl + "/oauth/token", HttpMethod.POST, requestEntity, Map.class);
  ...
  public void createClient(String adminAccessToken, BaseClientDetails clientDetails)
      throws Exception {
    restfulCreate(
        adminAccessToken, JsonUtils.writeValueAsString(clientDetails), uaaUrl + "/oauth/clients");
  }
  ...
  public void createUser(
      String scimAccessToken, String userName, String email, String password, Boolean verified)
      throws Exception {
