...
public final class MockMvcUtils {
  ...
  public static String performMfaPostVerifyWithCode(int code, MockMvc mvc, MockHttpSession session)
      throws Exception {
    return performMfaPostVerifyWithCode(code, mvc, session, "localhost");
  }

  public static String performMfaPostVerifyWithCode(
      int code, MockMvc mvc, MockHttpSession session, String host) throws Exception {
    return mvc.perform(
            post("/login/mfa/verify.do")
  ...
  public static int getMFACodeFromSession(MockHttpSession session) {
    UserGoogleMfaCredentials activeCreds =
        (UserGoogleMfaCredentials) session.getAttribute("uaaMfaCredentials");
  ...
  public static ResultActions performMfaRegistrationInZone(
      String username,
      String password,
      MockMvc mockMvc,
      String host,
      String[] firstAuthMethods,
      String[] afterMfaAuthMethods)
      throws Exception {
    ...
    assertThat(
        getUaaAuthentication(session).getAuthenticationMethods(),
        containsInAnyOrder(firstAuthMethods));

    // successful login, follow redirect
    mockMvc
        .perform(get("/").header(HOST, host).accept(MediaType.TEXT_HTML).session(session))
        .andExpect(status().isFound())
    ...
    location =
        mockMvc
            .perform(get(location).session(session).header(HOST, host))
            .andExpect(status().isFound())
    ...
    ResultActions resultActions =
        mockMvc.perform(get(location).session(session).header(HOST, host));

    assertTrue(getUaaAuthentication(session).isAuthenticated());
    assertThat(
        getUaaAuthentication(session).getAuthenticationMethods(),
        containsInAnyOrder(afterMfaAuthMethods));
  ...
  public static ScimUser getUserByUsername(MockMvc mockMvc, String username, String accessToken)
      throws Exception {
    ...
    SearchResults<ScimUser> results =
        JsonUtils.readValue(
  ...
  public static void setDisableInternalAuth(
      ApplicationContext context, String zoneId, boolean disable) {
    IdentityProviderProvisioning provisioning =
        context.getBean(JdbcIdentityProviderProvisioning.class);
    IdentityProvider<UaaIdentityProviderDefinition> uaaIdp =
        provisioning.retrieveByOriginIgnoreActiveFlag(OriginKeys.UAA, zoneId);
    uaaIdp.setActive(!disable);
    provisioning.update(uaaIdp, zoneId);
  }

  public static void setDisableInternalUserManagement(
      ApplicationContext context, String zoneId, boolean disabled) {
    IdentityProviderProvisioning provisioning =
        context.getBean(JdbcIdentityProviderProvisioning.class);
    IdentityProvider<UaaIdentityProviderDefinition> uaaIdp =
        provisioning.retrieveByOriginIgnoreActiveFlag(OriginKeys.UAA, zoneId);
  ...
  public static void setSelfServiceLinksEnabled(
      ApplicationContext context, String zoneId, boolean enabled) {
  ...
  public static void setZoneConfiguration(
      ApplicationContext context, String zoneId, IdentityZoneConfiguration configuration) {
  ...
  public static IdentityZoneConfiguration getZoneConfiguration(
      ApplicationContext context, String zoneId) {
    IdentityZoneProvisioning provisioning = context.getBean(IdentityZoneProvisioning.class);
    IdentityZone uaaZone = provisioning.retrieve(zoneId);
  ...
  public static InvitationsResponse sendRequestWithTokenAndReturnResponse(
    ...
    return JsonUtils.readValue(
        result.getResponse().getContentAsString(), InvitationsResponse.class);
  }

  public static URL inviteUser(
      ApplicationContext context,
      MockMvc mockMvc,
      String email,
      String userInviteToken,
      String subdomain,
      String clientId,
    ...
    InvitationsResponse response =
        sendRequestWithTokenAndReturnResponse(
            context, mockMvc, userInviteToken, subdomain, clientId, REDIRECT_URI, email);
    ...
    assertEquals(
        ...
        context
            ...
            .queryForObject(
                "SELECT origin FROM users WHERE username='" + email + "'", String.class));
  ...
  public static IdentityProvider createIdentityProvider(
    ...
    provider =
        MockMvcUtils.createIdpUsingWebRequest(
            mockMvc,
  ...
  public static ZoneScimInviteData createZoneForInvites(
      MockMvc mockMvc, ApplicationContext context, String userId, String redirectUri)
      throws Exception {
    RandomValueStringGenerator generator = new RandomValueStringGenerator();
    String superAdmin =
        getClientCredentialsOAuthAccessToken(mockMvc, "admin", "adminsecret", "", null);
    IdentityZoneCreationResult zone =
        MockMvcUtils.createOtherIdentityZoneAndReturnResult(
            generator.generate().toLowerCase(), mockMvc, context, null);

    List<String> redirectUris =
        Arrays.asList(
            redirectUri, "http://" + zone.getIdentityZone().getSubdomain() + ".localhost");
    BaseClientDetails appClient =
        new BaseClientDetails(
            "app",
            "",
            "scim.invite",
            "client_credentials,password,authorization_code",
            "uaa.admin,clients.admin,scim.write,scim.read,scim.invite",
  ...
  public static void setDisableInternalUserManagement(
      boolean disableInternalUserManagement, ApplicationContext applicationContext) {
    IdentityProviderProvisioning identityProviderProvisioning =
        applicationContext.getBean(JdbcIdentityProviderProvisioning.class);
    IdentityProvider<UaaIdentityProviderDefinition> idp =
        identityProviderProvisioning.retrieveByOrigin(
            OriginKeys.UAA, IdentityZone.getUaa().getId());
  ...
  public static IdentityZone createZoneUsingWebRequest(MockMvc mockMvc, String accessToken)
      throws Exception {
  ...
  public static class IdentityZoneCreationResult {
    ...
    public IdentityZoneCreationResult(
        IdentityZone identityZone, UaaPrincipal zoneAdmin, String zoneAdminToken) {
  ...
  public static IdentityZoneCreationResult createOtherIdentityZoneAndReturnResult(
      ...
      throws Exception {
    return createOtherIdentityZoneAndReturnResult(
        mockMvc, webApplicationContext, bootstrapClient, identityZone, true);
  }
  ...
  public static IdentityZoneCreationResult createOtherIdentityZoneAndReturnResult(
    ...
    String identityToken =
        getClientCredentialsOAuthAccessToken(
            mockMvc, "identity", "identitysecret", "zones.write,scim.zones", null);
    ...
    if (useWebRequests) {
      ...
      webApplicationContext
          ...
          .create(defaultIdp, identityZone.getId());
    }
    ...
    if (useWebRequests) {
      ...
      webApplicationContext
          .getBean(ScimGroupEndpoints.class)
          .addZoneManagers(group, Mockito.mock(HttpServletResponse.class));
    }

    // use that user to create an admin client in the new zone
    String zoneAdminAuthcodeToken =
        getUserOAuthAccessTokenAuthCode(
            mockMvc,
            "identity",
            "identitysecret",
            marissa.getId(),
    ...
    if (bootstrapClient != null) {
      if (useWebRequests) {
        ...
        webApplicationContext
            .getBean(MultitenantJdbcClientDetailsService.class)
            .addClientDetails(bootstrapClient, identityZone.getId());
      }
    }
  ...
  public static IdentityZoneCreationResult createOtherIdentityZoneAndReturnResult(
    ...
    return createOtherIdentityZoneAndReturnResult(
        mockMvc, webApplicationContext, bootstrapClient, identityZone, useWebRequests);
  }
  ...
  public static IdentityZoneCreationResult createOtherIdentityZoneAndReturnResult(
    ...
    return createOtherIdentityZoneAndReturnResult(
        subdomain, mockMvc, webApplicationContext, bootstrapClient, true);
  }

  public static IdentityZone createOtherIdentityZone(
      String subdomain,
      MockMvc mockMvc,
      ApplicationContext webApplicationContext,
      ClientDetails bootstrapClient)
      throws Exception {
    return createOtherIdentityZone(
        subdomain, mockMvc, webApplicationContext, bootstrapClient, true);
  }
  ...
  public static IdentityZone createOtherIdentityZone(
      ...
      throws Exception {
    return createOtherIdentityZoneAndReturnResult(
            subdomain, mockMvc, webApplicationContext, bootstrapClient, useWebRequests)
        .getIdentityZone();
  }

  public static IdentityZone createOtherIdentityZone(
      String subdomain, MockMvc mockMvc, ApplicationContext webApplicationContext)
      throws Exception {
  ...
  public static IdentityZone createOtherIdentityZone(
    ...
    return createOtherIdentityZone(
        subdomain, mockMvc, webApplicationContext, client, useWebRequests);
  }
  ...
  public static IdentityProvider createIdpUsingWebRequest(
      MockMvc mockMvc,
      String zoneId,
      String token,
  ...
  public static ScimUser createUser(MockMvc mockMvc, String accessToken, ScimUser user)
      throws Exception {
    return createUserInZone(mockMvc, accessToken, user, "");
  }

  public static ScimUser createUserInZone(
      MockMvc mockMvc, String accessToken, ScimUser user, String subdomain) throws Exception {
    return createUserInZone(mockMvc, accessToken, user, subdomain, null);
  }

  public static ScimUser createUserInZone(
      MockMvc mockMvc, String accessToken, ScimUser user, String subdomain, String zoneId)
      throws Exception {
  ...
  public static ScimUser readUserInZone(
      MockMvc mockMvc, String accessToken, String userId, String subdomain, String zoneId)
      throws Exception {
    String requestDomain = subdomain.equals("") ? "localhost" : subdomain + ".localhost";
  ...
  public static ScimUser createAdminForZone(MockMvc mockMvc, String accessToken, String scopes)
      throws Exception {
  ...
  public static ScimGroup getGroup(MockMvc mockMvc, String accessToken, String displayName)
      throws Exception {
    return getGroup(mockMvc, accessToken, displayName, null);
  }

  public static ScimGroup getGroup(
      MockMvc mockMvc, String accessToken, String displayName, String subdomain) throws Exception {
    ...
    SearchResults<ScimGroup> results =
        JsonUtils.readValue(
            mockMvc
                .perform(
                    builder
  ...
  public static ScimGroup createGroup(MockMvc mockMvc, String accessToken, ScimGroup group)
      throws Exception {
    return createGroup(mockMvc, accessToken, group, null);
  }

  public static ScimGroup createGroup(
      MockMvc mockMvc, String accessToken, String subdomain, ScimGroup group) throws Exception {
    MockHttpServletRequestBuilder post =
        post("/Groups")
            .header("Authorization", "Bearer " + accessToken)
            .contentType(APPLICATION_JSON)
  ...
  public static ScimGroup createGroup(
      MockMvc mockMvc, String accessToken, ScimGroup group, String zoneId) throws Exception {
    MockHttpServletRequestBuilder post =
        post("/Groups")
            .header("Authorization", "Bearer " + accessToken)
            .contentType(APPLICATION_JSON)
  ...
  public static ScimGroup updateGroup(MockMvc mockMvc, String accessToken, ScimGroup group)
      throws Exception {
    return updateGroup(mockMvc, accessToken, group, null);
  }

  public static ScimGroup updateGroup(
      MockMvc mockMvc, String accessToken, ScimGroup group, IdentityZone zone) throws Exception {
    ...
    return JsonUtils.readValue(
        mockMvc
            .perform(
                put.header("If-Match", group.getVersion())
                    .header("Authorization", "Bearer " + accessToken)
                    .contentType(APPLICATION_JSON)
                    .content(JsonUtils.writeValueAsString(group)))
            .andExpect(status().isOk())
  ...
  public static BaseClientDetails createClient(
      MockMvc mockMvc, String accessToken, BaseClientDetails clientDetails) throws Exception {
    return createClient(
        mockMvc, accessToken, clientDetails, IdentityZone.getUaa(), status().isCreated());
  }

  public static void deleteClient(
      MockMvc mockMvc, String accessToken, String clientId, String zoneSubdomain) throws Exception {
    MockHttpServletRequestBuilder createClientDelete =
        delete("/oauth/clients/" + clientId)
            .header("Authorization", "Bearer " + accessToken)
            .accept(APPLICATION_JSON);
    if (!zoneSubdomain.equals(IdentityZone.getUaa())) {
      createClientDelete =
          createClientDelete.header(IdentityZoneSwitchingFilter.SUBDOMAIN_HEADER, zoneSubdomain);
    }
    mockMvc.perform(createClientDelete).andExpect(status().is(not(500)));
  }
  ...
  public static BaseClientDetails createClient(
      ...
      throws Exception {
    MockHttpServletRequestBuilder createClientPost =
        post("/oauth/clients")
            .header("Authorization", "Bearer " + accessToken)
            .accept(APPLICATION_JSON)
            .contentType(APPLICATION_JSON)
  ...
  public static BaseClientDetails createClient(
      ApplicationContext context, BaseClientDetails clientDetails, IdentityZone zone)
      throws Exception {

    MultitenantJdbcClientDetailsService service =
        context.getBean(MultitenantJdbcClientDetailsService.class);
    service.addClientDetails(clientDetails, zone.getId());
    return (BaseClientDetails)
        service.loadClientByClientId(clientDetails.getClientId(), zone.getId());
  }

  public static ClientDetails createClient(
      MockMvc mockMvc,
  ...
  public static ClientDetails createClient(
    ...
    ClientDetailsModification client =
        getClientDetailsModification(
            id, secret, resourceIds, scopes, grantTypes, authorities, redirectUris);
    return createClient(mockMvc, adminAccessToken, client, zone, status().isCreated());
  }

  public static ClientDetailsModification getClientDetailsModification(
      String id,
      String secret,
      Collection<String> resourceIds,
      Collection<String> scopes,
    ...
    detailsModification.setAuthorities(
  ...
  public static BaseClientDetails updateClient(
      ApplicationContext context, BaseClientDetails clientDetails, IdentityZone zone)
      throws Exception {
    MultitenantJdbcClientDetailsService service =
        context.getBean(MultitenantJdbcClientDetailsService.class);
  ...
  public static BaseClientDetails updateClient(
      MockMvc mockMvc, String accessToken, BaseClientDetails clientDetails, IdentityZone zone)
      throws Exception {
  ...
  public static BaseClientDetails getClient(
      MockMvc mockMvc, String accessToken, String clientId, IdentityZone zone) throws Exception {
  ...
  public static String getZoneAdminToken(MockMvc mockMvc, String adminToken, String zoneId)
      throws Exception {
    String scope = "zones." + zoneId + ".admin";
    return getZoneAdminToken(mockMvc, adminToken, zoneId, scope);
  }

  public static String getZoneAdminToken(
      MockMvc mockMvc, String adminToken, String zoneId, String scope) throws Exception {
    ScimUser user = new ScimUser();
  ...
  public static String getUserOAuthAccessToken(
      MockMvc mockMvc,
      String clientId,
      String clientSecret,
      String username,
      ...
      String scope)
      throws Exception {
    return getUserOAuthAccessToken(
        mockMvc, clientId, clientSecret, username, password, scope, null);
  }
  ...
  public static String getUserOAuthAccessToken(
      ...
      throws Exception {
    return getUserOAuthAccessToken(
        mockMvc, clientId, clientSecret, username, password, scope, zone, false);
  }
  ...
  public static String getUserOAuthAccessToken(
    ...
    MvcResult result =
        mockMvc.perform(oauthTokenPost).andDo(print()).andExpect(status().isOk()).andReturn();
    OAuthToken oauthToken =
        JsonUtils.readValue(result.getResponse().getContentAsString(), OAuthToken.class);
    return oauthToken.accessToken;
  }

  public static String getClientOAuthAccessToken(
      MockMvc mockMvc, String clientId, String clientSecret, String scope) throws Exception {
  ...
  public static String getScimInviteUserToken(
      MockMvc mockMvc,
      String clientId,
      String clientSecret,
      IdentityZone zone,
    ...
    user =
        (zone == null)
            ? createUser(mockMvc, adminToken, user)
    ...
    ScimGroup group =
        getGroup(mockMvc, adminToken, scope, zone == null ? null : zone.getSubdomain());
    ...
    return getUserOAuthAccessToken(
        mockMvc, clientId, clientSecret, user.getUserName(), "password", "scim.invite", zone);
  }

  public static String getClientCredentialsOAuthAccessToken(
      MockMvc mockMvc, String clientId, String clientSecret, String scope, String subdomain)
      throws Exception {
    return getClientCredentialsOAuthAccessToken(
        mockMvc, clientId, clientSecret, scope, subdomain, false);
  }
  ...
  public static SecurityContext getUaaSecurityContext(
      String username, ApplicationContext context, IdentityZone zone) {
    try {
  ...
  public static <T extends ApplicationEvent> TestApplicationEventListener<T> addEventListener(
      GenericWebApplicationContext applicationContext, Class<T> clazz) {
    TestApplicationEventListener<T> listener = TestApplicationEventListener.forEventClass(clazz);
    applicationContext.addApplicationListener(listener);
    return listener;
  }
  ...
  public static void removeEventListener(
      ListableBeanFactory applicationContext, ApplicationListener listener) {
    Map<String, ApplicationEventMulticaster> multicasters =
        applicationContext.getBeansOfType(ApplicationEventMulticaster.class);
  ...
  public static class CookieCsrfPostProcessor implements RequestPostProcessor {
    ...
    public MockHttpServletRequest postProcessRequest(MockHttpServletRequest request) {
      ...
      request.setParameter(
          token.getParameterName(), useInvalidToken ? "invalid" + tokenValue : tokenValue);
      return request;
    }
  ...
  public static IdentityZone updateZone(MockMvc mockMvc, IdentityZone updatedZone)
      throws Exception {
    String token =
    ...
    String responseAsString =
        mockMvc
            .perform(
                put("/identity-zones/" + updatedZone.getId())
                    .header("Authorization", "Bearer " + token)
                    .contentType(APPLICATION_JSON)
                    .accept(APPLICATION_JSON)
