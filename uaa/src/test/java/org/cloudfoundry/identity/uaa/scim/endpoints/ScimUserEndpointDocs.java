...
class ScimUserEndpointDocs extends EndpointDocs {
  ...
  private final String startIndexDescription =
      "The starting index of the search results when paginated. Index starts with 1.";
  private final String countAndItemsPerPageDescription =
  ...
  private final String userIdDescription =
  ...
  private final String emailPrimaryDescription =
  ...
  private final String approvalsListDescription =
  ...
  private final String userActiveDescription =
      "Whether the user is allowed to log in. False acts as a soft delete; the user will not be able to log in.";
  private final String userVerifiedDescription =
      "Becomes true when the user verifies their email address.";
  private final String userOriginDescription =
  ...
  private final String userZoneIdDescription =
      "The Identity Zone this user belongs to. The value `uaa` refers to the default zone.";
  private final String passwordLastModifiedDescription =
  ...
  private final String passwordDescription =
      "User's password, required if origin is set to `uaa`. May be be subject to validations if the UAA is configured with a password policy.";
  ...
  private final String userLastLogonTimeDescription =
  ...
  private final String userPreviousLogonTimeDescription =
  ...
  private final String scimWriteOrUaaAdminRequired =
      "Access token with `scim.write` or `uaa.admin` required";
  private final String requiredUserUpdateScopes =
      "Access token with `scim.write`, `uaa.admin`, or `openid` required. The `openid` scope only allows the user to update their own first and last name.";
  ...
  private FieldDescriptor[] searchResponseFields = {
    ...
    fieldWithPath("resources[].phoneNumbers[].value")
        .type(STRING)
        .description(phoneNumbersDescription),
    ...
    fieldWithPath("resources[].emails[].primary")
        .type(BOOLEAN)
        .description(emailPrimaryDescription),
    ...
    fieldWithPath("resources[].groups[].display")
        .type(STRING)
        .description(groupDisplayNameDescription),
    ...
    fieldWithPath("resources[].approvals[].userId")
        .type(STRING)
        .description(approvalUserIdDescription),
    fieldWithPath("resources[].approvals[].clientId")
        .type(STRING)
        .description(approvalClientIdDescription),
    fieldWithPath("resources[].approvals[].scope")
        .type(STRING)
        .description(approvalScopeDescription),
    fieldWithPath("resources[].approvals[].status")
        .type(STRING)
        .description(approvalStatusDescription),
    fieldWithPath("resources[].approvals[].lastUpdatedAt")
        .type(STRING)
        .description(approvalsLastUpdatedAtDescription),
    fieldWithPath("resources[].approvals[].expiresAt")
        .type(STRING)
        .description(approvalsExpiresAtDescription),
    fieldWithPath("resources[].active").type(BOOLEAN).description(userActiveDescription),
    fieldWithPath("resources[].lastLogonTime")
        .optional(null)
        .type(NUMBER)
        .description(userLastLogonTimeDescription),
    fieldWithPath("resources[].previousLogonTime")
        .optional(null)
        .type(NUMBER)
        .description(userPreviousLogonTimeDescription),
    ...
    fieldWithPath("resources[].passwordLastModified")
        .type(STRING)
        .description(passwordLastModifiedDescription),
  ...
  private Snippet createFields =
      requestFields(
          ...
          fieldWithPath("name.formatted")
              .ignored()
              .type(STRING)
              .description("First and last name combined"),
          fieldWithPath("name.familyName")
              .optional(null)
              .type(STRING)
              .description(lastnameDescription),
          fieldWithPath("name.givenName")
              .optional(null)
              .type(STRING)
              .description(firstnameDescription),
          fieldWithPath("phoneNumbers")
              .optional(null)
              .type(ARRAY)
              .description(phoneNumbersListDescription),
          fieldWithPath("phoneNumbers[].value")
              .optional(null)
              .type(STRING)
              .description(phoneNumbersDescription),
          ...
          fieldWithPath("verified")
              .optional(false)
              .type(BOOLEAN)
              .description(userVerifiedDescription),
          fieldWithPath("origin")
              .optional(OriginKeys.UAA)
              .type(STRING)
              .description(userOriginDescription),
          ...
          fieldWithPath("meta.*")
              ...
              .ignored()
              .type(OBJECT)
              .description("SCIM object meta data not read."));
  ...
  private Snippet updateFields =
      requestFields(
          ...
          fieldWithPath("groups")
              .ignored()
              .type(ARRAY)
              .description("Groups are not created at this time."),
          fieldWithPath("approvals")
              .ignored()
              .type(ARRAY)
              .description("Approvals are not created at this time"),
          fieldWithPath("active").optional(true).type(BOOLEAN).description(userActiveDescription),
          fieldWithPath("verified")
              .optional(false)
              .type(BOOLEAN)
          ...
          fieldWithPath("passwordLastModified")
              .ignored()
              .type(STRING)
              .description(passwordLastModifiedDescription),
          fieldWithPath("externalId")
  ...
  private FieldDescriptor[] updateResponse = {
    ...
    fieldWithPath("approvals[].lastUpdatedAt")
        .type(STRING)
        .description(approvalsLastUpdatedAtDescription),
    ...
    fieldWithPath("zoneId").type(STRING).description(userZoneIdDescription),
    fieldWithPath("passwordLastModified").type(STRING).description(passwordLastModifiedDescription),
    fieldWithPath("lastLogonTime")
        .optional(null)
        .type(NUMBER)
        .description(userLastLogonTimeDescription),
    fieldWithPath("previousLogonTime")
        .optional(null)
        .type(NUMBER)
        .description(userLastLogonTimeDescription),
    fieldWithPath("externalId").type(STRING).description(externalIdDescription),
  ...
  private Snippet patchFields =
      requestFields(
          ...
          fieldWithPath("meta.*")
              ...
              .type(OBJECT)
              .description("SCIM object meta data not read."),
          fieldWithPath("meta.attributes")
              .optional(null)
              .type(ARRAY)
              .description(metaAttributesDesc));

  private final String scimFilterDescription = "SCIM filter for searching";
  private final String scimAttributeDescription =
  ...
  private ParameterDescriptor[] searchUsersParameters = {
    parameterWithName("filter")
        .optional(null)
        .description(scimFilterDescription)
    ...
    parameterWithName("sortOrder")
        ...
        .attributes(key("type").value(STRING)),
    parameterWithName("startIndex")
        .optional("1")
        .description(startIndexDescription)
  ...
  private ParameterDescriptor[] searchWithAttributes =
      ArrayUtils.addAll(
          searchUsersParameters,
          new ParameterDescriptor[] {
            parameterWithName("attributes")
                .optional(null)
                .description(scimAttributeDescription)
                .attributes(key("type").value(STRING))
          });
  ...
  void setUp() throws Exception {
    ...
    scimReadToken =
        MockMvcUtils.getClientCredentialsOAuthAccessToken(
            mockMvc, "admin", "adminsecret", "scim.read", null, true);
    scimWriteToken =
        MockMvcUtils.getClientCredentialsOAuthAccessToken(
            mockMvc, "admin", "adminsecret", "scim.write", null, true);
        ...
        .perform(
            get("/Users")
                ...
                .param(
                    "filter",
                    String.format(
                        "id eq \"%s\" or email eq \"%s\"", user.getId(), user.getUserName()))
                .param("sortBy", "email")
                .param("count", "50")
            ...
            document(
                ...
                requestHeaders(
                    headerWithName("Authorization")
                        .description("Access token with `scim.read` or `uaa.admin` required"),
            ...
            document(
                ...
                requestFields(
                    fieldWithPath("locked")
                        .optional(null)
                        .description(
                            "Set to `false` in order to unlock the user when they have been locked out according to the password lock-out policy. Setting to `true` will produce an error, as the user cannot be locked out via the API.")
                        .type(BOOLEAN)),
                responseFields(
                    fieldWithPath("locked")
                        .description("The `locked` value given in the request.")
                        .type(BOOLEAN))));
  }
        ...
        .andDo(
            document(
                ...
                requestHeaders(
                    ...
                    IDENTITY_ZONE_SUBDOMAIN_HEADER),
                requestFields(
                    fieldWithPath("passwordChangeRequired")
                        .optional(null)
                        .description(
                            "Set to `true` in order to force internal user’s password to expire")
                        .type(BOOLEAN)),
                responseFields(
                    fieldWithPath("passwordChangeRequired")
                        .description("The `passwordChangeRequired` value given in the request.")
                        .type(BOOLEAN))));
  }
        ...
        .andDo(
            document(
                ...
                requestHeaders(
                    ...
                    headerWithName("If-Match")
                        .optional()
                        .description("The version of the SCIM object to be deleted. Optional."),
                    IDENTITY_ZONE_ID_HEADER,
                    IDENTITY_ZONE_SUBDOMAIN_HEADER),
                responseFields(updateResponse)));
  }
  ...
  void test_Change_Password() throws Exception {
    ...
    String myToken =
        MockMvcUtils.getUserOAuthAccessToken(
            mockMvc, "app", "appclientsecret", user.getUserName(), "secret", null, null, true);
    ...
    mockMvc
        ...
        .andDo(
            document(
                ...
                requestHeaders(
                    headerWithName("Authorization")
                        .description("Access token with `password.write` or `uaa.admin` required"),
                    IDENTITY_ZONE_ID_HEADER,
                    IDENTITY_ZONE_SUBDOMAIN_HEADER),
                requestFields(
                    fieldWithPath("oldPassword")
                        .required()
                        .description(
                            "Old password. Optional when resetting another users password as an admin with `uaa.admin` scope")
                        .type(STRING),
                    fieldWithPath("password").required().description("New password.").type(STRING)),
                responseFields(
                    fieldWithPath("status")
                        .description("Will be 'ok' if password changed successfully."),
  ...
  void getUserVerificationLink() throws Exception {
    String accessToken =
        testClient.getClientCredentialsOAuthAccessToken("admin", "adminsecret", "uaa.admin");
    ...
    MockHttpServletRequestBuilder get =
        RestDocumentationRequestBuilders.get("/Users/{userId}/verify-link", joel.getId())
    ...
    Snippet requestHeaders =
        requestHeaders(
            headerWithName("Authorization")
                .description("The bearer token, with a pre-amble of `Bearer`"),
            IDENTITY_ZONE_ID_HEADER,
            IDENTITY_ZONE_SUBDOMAIN_HEADER);
    ...
    Snippet responseFields =
        responseFields(
            fieldWithPath("verify_link")
                .description("Location the user must visit and authenticate to verify"));
  ...
  void directlyVerifyUser() throws Exception {
    ...
    MockHttpServletRequestBuilder get =
        RestDocumentationRequestBuilders.get("/Users/{userId}/verify", billy.getId())
            .header("Authorization", "Bearer " + accessToken)
            .header("If-Match", "12")
            .accept(APPLICATION_JSON);
  ...
  void deleteMfaRegistration() throws Exception {
    ...
    Snippet requestHeaders =
        requestHeaders(
            headerWithName("Authorization")
                .description("Access token with `zones.<zoneId>.admin` or `uaa.admin` required."),
            IDENTITY_ZONE_ID_HEADER,
            IDENTITY_ZONE_SUBDOMAIN_HEADER);
    ...
    MockHttpServletRequestBuilder delete =
        RestDocumentationRequestBuilders.delete("/Users/{userId}/mfa", tommy.getId())
            .header("Authorization", "Bearer " + accessToken);
