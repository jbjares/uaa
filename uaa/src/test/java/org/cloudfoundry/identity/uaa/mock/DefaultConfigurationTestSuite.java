...
public class DefaultConfigurationTestSuite extends UaaBaseSuite {
  ...
  public static Class<?>[] suiteClasses() {
    ...
    // Class<?>[] result = new Class[] {LimitedModeLoginMockMvcTests.class,
    // LoginMockMvcTests.class};
    // Class<?>[] result = new Class[] {IdentityProviderEndpointsMockMvcTests.class,
  ...
  public static void clearDatabase() {
    ...
    webApplicationContext.setConfigLocations(
        "classpath:spring/env.xml", "classpath:spring/data-source.xml");
  ...
  public static XmlWebApplicationContext setUpContext() {
    ...
    new YamlServletProfileInitializerContextInitializer()
        .initializeContext(
            ...
            "endpoint_test_config.yml,uaa.yml,login.yml,required_configuration.yml");
    webApplicationContext.setConfigLocation("file:./src/main/webapp/WEB-INF/spring-servlet.xml");
    webApplicationContext.refresh();
    webApplicationContext.registerShutdownHook();

    EventFactory honeycombEventFactory =
        honeycombEventFactory(
  ...
  private static EventFactory honeycombEventFactory(
      String honeycombKey, String dataset, String testId) {
  ...
  private static HoneycombAuditEventTestListener
      honeycombAuditEventTestListenerAuthenticationFailureLockedEvent(
