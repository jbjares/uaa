 ...
 * org.cloudfoundry.identity.uaa.mock.InjectedMockContextTest base class. by default all sub classes
 * will be run, in random order. For a suite to change the classes to be run, simply implemement a
 * method with the following signature public static Class<?>[] suiteClasses()
 */
public class UaaJunitSuiteRunner extends Suite {
  ...
  protected static Class<?>[] allSuiteClasses() {
    ...
    Set<Class<? extends InjectedMockContextTest>> subTypes =
        reflections
            .getSubTypesOf(InjectedMockContextTest.class)
            .stream()
  ...
  public UaaJunitSuiteRunner(final Class<?> klass, RunnerBuilder builder)
  ...
  protected UaaJunitSuiteRunner(Class<?> klass, Class<?>[] suiteClasses)
      throws InitializationError {
