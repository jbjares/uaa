    ...
    for (String host : Arrays.asList("localhost", "subdomain.localhost")) {
      for (String url :
        ...
        OpenIdConfiguration openIdConfiguration =
            JsonUtils.readValue(response.getContentAsString(), OpenIdConfiguration.class);
        ...
        assertArrayEquals(
            new String[] {"RS256", "HS256"},
            openIdConfiguration.getTokenEndpointAuthSigningValues());
        ...
        assertArrayEquals(
            ...
            openIdConfiguration.getScopes());
        assertArrayEquals(
            new String[] {"code", "code id_token", "id_token", "token id_token"},
            openIdConfiguration.getResponseTypes());
        assertArrayEquals(
            new String[] {"RS256", "HS256"}, openIdConfiguration.getIdTokenSigningAlgValues());
        ...
        assertArrayEquals(
            ...
            openIdConfiguration.getClaimsSupported());
        assertFalse(openIdConfiguration.isClaimsParameterSupported());
        assertEquals(
            "http://docs.cloudfoundry.org/api/uaa/", openIdConfiguration.getServiceDocumentation());
  ...
  public void testUserInfoEndpointIsCorrect() throws Exception {
    for (String host : Arrays.asList("localhost", "subdomain.localhost")) {
      for (String url :
        ...
        mockMvc
            .perform(get(openIdConfiguration.getUserInfoUrl()))
