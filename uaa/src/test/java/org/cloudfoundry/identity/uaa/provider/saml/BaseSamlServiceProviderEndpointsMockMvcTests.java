...
public abstract class BaseSamlServiceProviderEndpointsMockMvcTests extends InjectedMockContextTest {
  ...
  public void setup() throws Exception {
    adminToken =
        MockMvcUtils.getClientCredentialsOAuthAccessToken(
            getMockMvc(), "admin", "adminsecret", "uaa.admin", null);
    ...
    zone =
        zoneSwitching
            ? MockMvcUtils.createOtherIdentityZone(
                generator.generate().toLowerCase(), getMockMvc(), getWebApplicationContext())
            : IdentityZone.getUaa();
    ...
    spsWriteToken =
        MockMvcUtils.getClientCredentialsOAuthAccessToken(
            getMockMvc(), clientId, clientSecret, scope, null);
    ...
    requestBody =
        "{\n"
            ...
            + "  \"active\" : true,\n"
            + "  \"config\" : \"{\\\"metaDataLocation\\\" : \\\"<?xml version=\\\\\\\"1.0\\\\\\\" encoding=\\\\\\\"UTF-8\\\\\\\"?><md:EntityDescriptor xmlns:md=\\\\\\\"urn:oasis:names:tc:SAML:2.0:metadata\\\\\\\" ID=\\\\\\\""
            + name
            ...
            + name
            + ".cloudfoundry-saml-login\\\\\\\" index=\\\\\\\"0\\\\\\\" isDefault=\\\\\\\"true\\\\\\\"/></md:SPSSODescriptor></md:EntityDescriptor>\\\",\\\"metadataTrustCheck\\\" : true }\""
            + "}";
  }

  private ResultActions perform(MockHttpServletRequestBuilder request) throws Exception {
    return getMockMvc()
        .perform(zoneSwitching ? request.header("X-Identity-Zone-Id", zone.getId()) : request);
  }
  ...
  public void deleteServiceProvider() throws Exception {
    ...
    MockHttpServletResponse deletedResponse =
        perform(
    ...
    SamlServiceProvider deletedServiceProvider =
        JsonUtils.readValue(deletedResponse.getContentAsString(), SamlServiceProvider.class);
  ...
  public void deleteServiceProviderWithInsufficientScopes() throws Exception {
    ...
    String spsReadToken =
        MockMvcUtils.getClientCredentialsOAuthAccessToken(
            getMockMvc(), spsReadClientId, spsReadClientSecret, "sps.read", null);
  ...
  public void deleteServiceProviderThatDoesNotExist() throws Exception {
    perform(
            delete("/saml/service-providers/{id}", "nonExistentId")
                .header("Authorization", "Bearer " + spsWriteToken)
                .accept(APPLICATION_JSON))
  ...
  public void createServiceProvider() throws Exception {
    performCreateServiceProvider().andExpect(status().isCreated());
  }
  ...
  public void duplicateServiceProvider_isConflict() throws Exception {
    ...
    performCreateServiceProvider().andExpect(status().isConflict());
  }
  ...
  public void createServiceProviderAttributeMappings() throws Exception {
    ...
    assertEquals(
        "firstname",
        serviceProvider.getConfig().getAttributeMappings().get(GIVEN_NAME_ATTRIBUTE_NAME));
    assertEquals(
        "lastname",
        serviceProvider.getConfig().getAttributeMappings().get(FAMILY_NAME_ATTRIBUTE_NAME));
    assertEquals(
        "phone",
        serviceProvider.getConfig().getAttributeMappings().get(PHONE_NUMBER_ATTRIBUTE_NAME));
  }
  ...
  public void updateServiceProviderAttributeMappings() throws Exception {
    ...
    response =
        performUpdateServiceProvider(serviceProvider.getId())
            .andExpect(status().isOk())
            .andReturn()
            .getResponse()
            .getContentAsString();
